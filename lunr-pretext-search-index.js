...
var ptx_lunr_docs = [
{
  "id": "preface-skeletal",
  "level": "1",
  "url": "preface-skeletal.html",
  "type": "Preface",
  "number": "",
  "title": "How to Use These Notes",
  "body": " How to Use These Notes  These are skeletal notes. Every section carries the definitions, the statements of the theorems, and the outline of each example and each proof but the details are left blank, and we fill them in together in class. What you are holding is the scaffolding of the course; the mathematics gets written into it as we do it.  Wherever a derivation, a solution, or a sketch belongs, there is a blank box, and in front of it a short parenthetical instruction saying what has to be done there which formula to reach for, what to watch out for, what to conclude but not how to do it. The figures, the animations, and the interactive applets that follow a box are the check on what you wrote in it.  So bring them with you. Before each class, print the section we are about to cover, or download it and annotate it on a tablet the PDF button in the navigation bar gives you the whole book as one file to print from. That file is rebuilt every time new notes are posted, so download a fresh copy rather than printing from an old one. Then complete the blanks in class as we work through the material. A page you filled in yourself is worth more later than any set of notes handed to you finished.  The assignments, with their answer boxes and the AI tutor, and the review problem sets are unchanged from the completed notes. They live online only, in the chapter Assignments and Review Problems of the web version of this book at mahmadi-ops.github.io\/MATH14-Skeletal ; they are meant to be worked there, not on paper, so they are not in the PDF.  "
},
{
  "id": "preface-skeletal-2",
  "level": "2",
  "url": "preface-skeletal.html#preface-skeletal-2",
...
},
{
  ...
  "body": " Parametrization of Curves     Describe the motion of a point in the plane with a pair of parametric equations and , and understand the parameter as recording when the point visits each place on the curve.    Sketch a parametric curve from its parametric equations, and indicate the direction of increasing in which the curve is traced.    Find parametric equations for common curves, such as lines, circles, and ellipses, and eliminate the parameter to recover a Cartesian equation when possible.    Distinguish the intersection points of two parametric curves from their collision points , where two moving objects reach the same place at the same time.    Write a space curve as a vector function , and parametrize the curve in which two surfaces meet.    Differentiate a vector function to get the tangent vector of a space curve, and write the equation of the tangent line at a point of the curve.      Imagine that you would like to describe the motion of an object whose motion is confined to a plane. If you know how its Cartesian coordinates, and , change as time passes, you will be able to draw a curve that represents the trajectory of its motion. Mathematically, we will need two equations to demonstrate how the and -coordinates evolve in time , which are known as the parametric equations. This section reviews that language and then extends it to curves in space, where it becomes the main tool for everything that follows.   These are skeletal notes: the definitions, theorems, and problem statements are given, and blank boxes are left wherever a derivation, a solution, or a sketch belongs, so that you can fill them in by hand.      Parametric Equations   Parametric Equations   If and are given as functions of a third variable , called a parameter , by   then the points trace out a curve in the plane, called a parametric curve . The equations and are the parametric equations of the curve.    As runs over its interval, the point moves, and the trail it leaves behind is the curve. The parameter therefore carries more information than the picture does: it also records when the moving point is at each place, as in .   The trajectory of a moving point whose coordinates are given by the parametric equations , . At the instant the point is at .   A curved trajectory in the plane with a marked point and dashed lines dropping to the two coordinate axes.   A smooth curve rises and falls across the first quadrant from a starting point A, reached at time t equals a, to an ending point B, reached at time t equals b. A single point on the curve is marked; dashed gray segments run from it straight down to the x axis, where the value is labeled f of t nought, and straight left to the y axis, where the value is labeled g of t nought. An arrow on the curve shows the direction of increasing t.     c(t) = (t, 2 + sin(t))  t0 = 2  P = c(t0)       C       A,\\ t=a     B,\\ t=b         \\left(f(t_0),g(t_0)\\right)    f(t_0)    g(t_0)                  As an example, consider and . Fill in , plot the seven points on the grid below, and join them. (Then eliminate the parameter to name the curve, and mark on your sketch the direction in which it is traced as increases.)   Points on the curve ,                    Empty coordinate grid running from negative four to four horizontally and negative one to ten vertically, for plotting the seven points from the table and joining them.     Blank box in two rows, one for eliminating the parameter and one for naming the curve and the direction in which it is traced.    As our second example, consider the equation of the circle centered at with unit radius,   Here, we would like to parametrize and in terms of a single parameter , as in , in such a way that by varying the value of we can reconstruct the circle . Find such a pair.     Blank box in two rows, one for the parametrization and one for the interval of the parameter and the verification.     The unit circle .   The unit circle on a coordinate grid.   The unit circle, centered at the origin with radius one, drawn on a coordinate grid with the x and y axes.     c(t) = (cos(t), sin(t))                    Question   Can you think of another way to write a parametric form of the circle ?     Blank workspace for a second parametrization of the unit circle.         Some Examples of Parametrizing Curves   Parametrizing Curves   Find the parametric equations corresponding to the following curves.    The line segment connecting the two points and .    The ellipse .    The circle of radius centered at .     Solution.      Blank box in three labelled rows, one for each of the three parametrizations together with its verification.    Now sketch the three curves on the grids below, marking the point reached at and the direction of increasing on each.      Empty coordinate grid for part A, for sketching the segment from zero comma one to one comma zero.     Empty coordinate grid for part B, running from negative three and a half to three and a half in both directions, for sketching the ellipse.     Empty coordinate grid for part C, running from negative one to five horizontally and negative three to three vertically, for sketching the circle centered at two comma zero.         Intersection Points versus Collision Points  A parametrization carries more information than the curve it traces: it also records when the moving point visits each place on the curve. Because of this, there are two different questions we can ask about two parametric curves   thought of as the trajectories of two particles.   Intersection Points and Collision Points   A point is an intersection point of the two curves if lies on both curves; that is, if there are parameter values and , not necessarily equal, with   A point is a collision point of the two particles if both particles are at at the same time; that is, if there is a single value of with     An intersection point is a statement about the two paths : they cross, like two roads on a map. A collision point is a statement about the two motions : the cars are at the crossroads at the same instant.   True or False   Decide whether each statement is true or false.    Every collision point of two particles is an intersection point of their paths.    Every intersection point of two paths is a collision point of the particles that travel along them.       Blank box in two rows, one for each statement, for the verdict and the reason.       True or False   In practice the distinction dictates how we set up the equations. Decide whether each statement is true or false.    To find the intersection points of the curves and , give the two curves different parameter names and solve , for the pair .    To find the collision points of the two particles, eliminate the parameters and intersect the two Cartesian curves.       Blank box in two rows, one for each statement, for the verdict and the reason.        Two particles move in the plane with position vectors   Find all intersection points of their paths, and all collision points of the particles.   Solution.      Blank box in three rows, for the two paths after eliminating the parameter and the points where they meet, for the collision equations, and for the times at which each particle reaches each crossing.       The parabola and the line ; compare with what you found.   A parabola labelled C one and a line labelled C two crossing at two points, each marked with a dot.   The parabola y equals x squared, labelled C one, and the line y equals x plus two, labelled C two, drawn on the same coordinate grid with arrows showing the direction of travel. Their two crossings are marked with red dots and are not labelled.     p(t) = (t, t^2)  l(t) = (-t, 2-t)        C_1       C_2                         Keep the first particle, but re-schedule the second one:   Find the intersection points of the paths and the collision points of the particles.   Solution.      Blank box in three rows, for the paths, for the collision computation, and for what happens at the other crossing.     Empty coordinate grid running from negative four to four horizontally and negative two to six vertically, for drawing the parabola and the line and marking the collision point.        Keep . Find a parametrization of the line for which the two particles collide at both intersection points.     Blank box in two rows, one for the new parametrization of the line and one for the collision equations it produces.         Curves in Space and Vector Functions  Assume that we are interested in describing the path of an object in space. To this aim, we can specify its location at each instant of time; that is, we can write its coordinates in as   Here is the time parameter, which varies from some initial time to some final time , that is, . Nothing has changed, except that where a plane curve needed the two equations , a space curve needs three.  There is a second, more compact way to look at , and it is the point of view we will use for the rest of the course. Instead of three separate coordinate equations, collect the coordinates into a single vector function  a function whose input is a real number and whose output is a vector:   Think of as the position vector of the moving object: an arrow drawn from the origin to the object's location at time . As increases, the arrow swings around and changes length, and its tip sweeps out the curve. So a parametrization can be read in two equivalent ways.     Coordinatewise. Three ordinary scalar functions , , of one variable, one for each coordinate, as in .     Vectorially. One vector-valued function of one variable, as in . The curve is the set of tips of the vectors .    The two descriptions carry exactly the same information, but the vector form is the more useful one: it lets us differentiate and integrate a whole motion at once, and its derivative will turn out to be the velocity of the moving object. The same device works in the plane, where ; the position vectors and of were already written this way.   A helix   Consider the object whose coordinates are parametrized by   Write the motion as a vector function and describe the path.   Solution.      Blank box in four rows, for the vector function, for the shadow of the path on the x y plane, for the behaviour of the height, and for the name of the curve with its starting and ending points.     One turn of the helix , . The violet arrow is the position vector at ; its tip rides along the curve as increases. The dashed gray circle is the shadow of the path on the plane .   One turn of a helix rising above the unit circle, with the position vector drawn from the origin to a point on the curve.   A three-dimensional coordinate box with x and y running from minus 1.3 to 1.3 and z from 0 to about 3.4. A thick blue curve spirals counterclockwise once around the vertical axis while climbing steadily, starting at a red point labeled (1,0,0) at time t equals zero on the floor of the box and ending at a red point labeled (1,0,pi) at time t equals pi, directly above the start. A dashed gray unit circle on the floor is the shadow of the path. A violet arrow labeled r of t runs from the origin to a point partway up the curve, illustrating the position vector whose tip traces the helix.      The same helix, animated, and continued past to three full turns, is . Press Play to watch the point climb the curve, with its shadow running around the unit circle below and the position vector following it; or drag the slider to place the point yourself.   The helix , animated, for : the curve of the example is the first turn, up to . Top view looks straight down the -axis, where the whole helix collapses onto its projection, the unit circle in the -plane.      There are situations in which a curve in space arises as the intersection of two surfaces. In the next two examples we turn such a description into a vector function .   Where a plane cuts a cylinder   Find a vector function that represents the curve of intersection of the cylinder and the plane .   Solution.      Blank box in four rows, for the x and y coordinates, for z, for the assembled vector function with the range of t, and for the check at four parameter values.     The cylinder , the plane , and the ellipse in which they meet. The violet arrow is the position vector of your parametrization at .   A vertical cylinder cut by a slanted plane, with the ellipse where they meet drawn on the surfaces.   A three-dimensional plot showing a vertical circular cylinder of radius one standing on the xy-plane, and a slanted plane cutting through it. The two meet along a closed curve, an ellipse, drawn as a thick magenta loop and labeled C. Four points on the ellipse are marked, at (1,0,2), (0,1,1), (-1,0,2) and (0,-1,3). A violet arrow runs from the origin to a point on the ellipse, illustrating the position vector r of t.         Where two curved surfaces meet   Parametrize the intersection of the surfaces    Solution.      Blank box in three rows: an unlabelled one for finding the shadow of the curve, one for the parametrization of the shadow, and one for z of t with the assembled vector function.     The upper sheet of (blue) and the dome (red) meet along the closed curve drawn in black. Its shadow in the plane is the dashed ellipse; compare it with the equation you found.   A bowl-shaped surface and a dome overlapping, with the closed curve where they meet drawn on them.   A three-dimensional plot showing two surfaces. The first, in blue, is the upper sheet of a hyperboloid opening upward from its lowest point at height one above the origin. The second, in red, is a dome, the upper half of an ellipsoid, reaching height two above the origin. The two surfaces cross along a closed curve, drawn in black, which loops around the vertical axis at heights between about 1.26 and 1.58. A dashed ellipse on the floor of the box shows the shadow of that curve.                     Tangent Lines to Curves in Space  Now that a curve in space is a vector function , we can ask the same question we asked about graphs in single-variable calculus: what is the tangent line at a point of the curve? The applet in shows how to find its direction. Fix a time , mark the point that the moving object occupies at that time, and let be a small change in time.   The tangent vector as the limit of a difference quotient. The gray curve is the helix , and the two blue arrows are the position vectors and , with . The pink arrow is their difference , the green arrow is the difference quotient , and the green line is the tangent line at .     The pink arrow joins the point of the curve at time to the point of the curve at time : it is a chord of the curve. Dividing it by gives the green arrow   (Explain what dividing by does to the chord, including when , and why the green arrow becomes tangent to the curve at as ; compare with .)     Blank box in two rows, one for what dividing the chord by h does and one for what happens to the difference quotient as h tends to zero.    The limit of the difference quotient is therefore a vector tangent to the curve at . We call it the tangent vector , or the velocity , of the path:   The limit in is taken one coordinate at a time, so if , then : to differentiate a vector function, differentiate each of its coordinates. The tangent vector at the time is   The tangent line at is the line through in the direction of . (Write the position vector of , then use the vector equation of a line from MATH 13. Use a new parameter for the line, and say why it must differ from .)     Blank box in three rows, for the position vector of the point P, for the vector equation of the tangent line, and for why the line needs its own parameter.     The tangent line  The tangent line to the curve at , with , is     Tangent line to a helix   Find the tangent line to the path at the point .   Solution. (First find the time at which the path passes through the point, and check all three coordinates. Then apply , and give the answer in both vector and parametric form; compare with the green line in .)     Blank box in five rows, for the time at which the path passes through the point, for the tangent vector, for its value at that time, for the tangent line in vector form, and for the tangent line in parametric form.    The same construction, animated, is . Press Play for a guided tour, or drag toward and watch the green difference quotient turn onto the gold tangent line.   The tangent vector as a limit, animated. The helix for , the point with , the position vectors and (violet), the chord (pink), the difference quotient (green), and the tangent line at with the tangent vector (gold).       "
},
{
...
},
{
  ...
  "number": "1.1.4",
  "title": "",
  "body": " The unit circle .   The unit circle on a coordinate grid.   The unit circle, centered at the origin with radius one, drawn on a coordinate grid with the x and y axes.     c(t) = (cos(t), sin(t))                  "
},
{
...
{
  "id": "fig-intersection-no-collision",
  "level": "2",
  "url": "sec-parametrization.html#fig-intersection-no-collision",
  "type": "Figure",
  "number": "1.1.11",
  "title": "",
  "body": " The parabola and the line ; compare with what you found.   A parabola labelled C one and a line labelled C two crossing at two points, each marked with a dot.   The parabola y equals x squared, labelled C one, and the line y equals x plus two, labelled C two, drawn on the same coordinate grid with arrows showing the direction of travel. Their two crossings are marked with red dots and are not labelled.     p(t) = (t, t^2)  l(t) = (-t, 2-t)        C_1       C_2                      "
},
{
  ...
  "number": "1.1.12",
  "title": "",
  "body": "  Keep the first particle, but re-schedule the second one:   Find the intersection points of the paths and the collision points of the particles.   Solution.      Blank box in three rows, for the paths, for the collision computation, and for what happens at the other crossing.     Empty coordinate grid running from negative four to four horizontally and negative two to six vertically, for drawing the parabola and the line and marking the collision point.     "
},
{
  ...
  "number": "1.1.13",
  "title": "",
  "body": "  Keep . Find a parametrization of the line for which the two particles collide at both intersection points.     Blank box in two rows, one for the new parametrization of the line and one for the collision equations it produces.     "
},
{
...
},
{
  ...
  "number": "1.1.14",
  "title": "A helix.",
  "body": " A helix   Consider the object whose coordinates are parametrized by   Write the motion as a vector function and describe the path.   Solution.      Blank box in four rows, for the vector function, for the shadow of the path on the x y plane, for the behaviour of the height, and for the name of the curve with its starting and ending points.     One turn of the helix , . The violet arrow is the position vector at ; its tip rides along the curve as increases. The dashed gray circle is the shadow of the path on the plane .   One turn of a helix rising above the unit circle, with the position vector drawn from the origin to a point on the curve.   A three-dimensional coordinate box with x and y running from minus 1.3 to 1.3 and z from 0 to about 3.4. A thick blue curve spirals counterclockwise once around the vertical axis while climbing steadily, starting at a red point labeled (1,0,0) at time t equals zero on the floor of the box and ending at a red point labeled (1,0,pi) at time t equals pi, directly above the start. A dashed gray unit circle on the floor is the shadow of the path. A violet arrow labeled r of t runs from the origin to a point partway up the curve, illustrating the position vector whose tip traces the helix.      The same helix, animated, and continued past to three full turns, is . Press Play to watch the point climb the curve, with its shadow running around the unit circle below and the position vector following it; or drag the slider to place the point yourself.   The helix , animated, for : the curve of the example is the first turn, up to . Top view looks straight down the -axis, where the whole helix collapses onto its projection, the unit circle in the -plane.     "
},
{
  ...
  "body": " Where a plane cuts a cylinder   Find a vector function that represents the curve of intersection of the cylinder and the plane .   Solution.      Blank box in four rows, for the x and y coordinates, for z, for the assembled vector function with the range of t, and for the check at four parameter values.     The cylinder , the plane , and the ellipse in which they meet. The violet arrow is the position vector of your parametrization at .   A vertical cylinder cut by a slanted plane, with the ellipse where they meet drawn on the surfaces.   A three-dimensional plot showing a vertical circular cylinder of radius one standing on the xy-plane, and a slanted plane cutting through it. The two meet along a closed curve, an ellipse, drawn as a thick magenta loop and labeled C. Four points on the ellipse are marked, at (1,0,2), (0,1,1), (-1,0,2) and (0,-1,3). A violet arrow runs from the origin to a point on the ellipse, illustrating the position vector r of t.       "
},
{
  "id": "ex-two-surfaces",
  "level": "2",
...
{
  "id": "subsec-tangent-line-space-curve-7",
  "level": "2",
  "url": "sec-parametrization.html#subsec-tangent-line-space-curve-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Line Integrals   In this section we study line integrals of scalar functions. We develop the idea through a concrete problem: finding the mass of a curved wire when we know its density its mass per unit length at every point. The strategy is the one behind every integral: chop the wire into tiny pieces, multiply the density of each piece by its length, and add up the results .     Line Integrals of Scalar Functions  Suppose we would like to compute the mass of a wire that does not have a trivial shape (such as a straight line). If the wire were straight and its density constant, the mass would simply be density times length. For a curved wire whose density varies from point to point, neither shortcut is available but we can approximate mass of small portions of the wire by treating each as if it were straight and had constant density.  Assume the wire is represented by a curve in space, parametrized by , as in . Divide the wire into small portions, and denote the length of the th portion by . Pick a sample point on this portion. If the portion is short, the density is nearly constant along it, so   and summing over all portions,    A wire represented by a curve in space, parametrized by and cut into portions by the partition points (black dots). The th portion (black) has length and contains the sample point , located by the position vector . The red chords form the inscribed polygon that approximates ; here its total length falls about short of the length of .   A helical wire cut into eight portions by dots, with the inscribed polygon of red chords, one portion highlighted in black, and a position vector reaching from the origin to a sample point on it.   A helical wire rising counterclockwise around the vertical axis from its lower end, marked t equals a, to its upper end, marked t equals b. Eight dots cut the wire into seven portions, and a straight red chord joins the ends of each portion, so the chords form a polygon inscribed in the wire that visibly cuts inside every bend. One portion on the near side is drawn in thick black and labeled with its length, delta s sub k; a dot inside it is the sample point, and a dashed green arrow runs to that dot from the origin, labeled r of t sub k equals the vector with components x sub k, y sub k, z sub k.      The estimate is only an approximation, because the density is not actually constant over each portion. How can we make the calculation exact? We take the limit in which every portion becomes infinitely small, that is, , or equivalently :   The limit in is denoted by the integral   which is read as the line integral of over the curve . The process is animated in : as the partition refines, the sums settle down to the value of the integral.   The construction above, on the wire of : the wire is cut into portions, and the th of them, of length , carries a sample point , so its mass is about . As grows the portions shrink, and the sum settles down to the line integral .    Our final task is to write the line element in terms of , so the integral becomes an ordinary integral we can evaluate.     Blank box in four rows, for the line element in terms of dx, dy and dz, for the substitution into the mass integral with dt factored out, an unlabelled one, and for the resulting formula for the mass.     Results  For a wire parametrized by , , with velocity , the line element is   so the mass of the wire is   There is nothing special about density here. In general, a scalar line integral has the form    where is a scalar-valued function and the curve specifies the region of integration. Once the curve is parametrized in terms of , the region of integration translates to . In words: to compute a line integral, trade the geometric element for the parameter element . Two sanity checks connect this to what we already know. Taking in recovers the arc length of total length is the mass of a wire of density one. And is exactly the speed from that section, so the factor converts time spent into distance covered.      Mass and length of a helical wire   Consider a wire of length and mass . The wire is helix-shaped, with its bottom end located at and parametric equation Its density (mass per unit length) is kg\/m. Assuming that kg, calculate the length of the wire.   Solution.      Blank box in five rows, for the velocity and speed, for the density along the curve, for the mass integral up to the unknown upper limit, for solving for that limit, and for the length of the wire.     The helical wire , from its bottom end to its top end. The dashed gray curve is its shadow on the plane . Compare the top end with the value of you found.   A piece of a helix rising from the point (1,0,0) to an unlabelled top end, with its shadow on the floor.   A three-dimensional coordinate box with x and y running from minus 1.2 to 1.2 and z from 0 to 1.8. A thick blue helix starts at a red point on the floor labelled (1, 0, 0), t equals 0, and climbs steadily as it curves, ending at an unlabelled red point. A dashed gray arc on the floor of the box shows the curve's shadow.       A point traverses the helical wire while the accumulated mass grows. Use it to check the mass, the value of , and the length you found.         A wire whose density is read off the picture   A wire of length meters is parametrized as   where , and are in meters and is in seconds. Assume that the mass density at a point of the wire is   where is the distance from to the -axis.  The wire is graphed in . Note that there is a piece of information that has to be extracted from the graph. Calculate the mass of the wire.   Solution.      Blank box in six rows, for the starting parameter value read off the graph, for the velocity and speed, for the equation that fixes the upper limit, for the density in terms of t, for the mass integral, and for the meaning of the cancellation.     The wire , spiralling outward and upward from the origin. The dashed gray curve is its shadow on the plane .   A wire spiralling outward and upward from the origin, with its shadow on the ground.   A three-dimensional coordinate box with x and y running from minus 8.5 to 8.5 and z from 0 to 22. A thick blue curve starts at a red point at the origin and spirals outward and upward, making a little more than one full turn around the vertical axis while climbing, its radius growing steadily, until it ends high above the floor. A dashed gray spiral on the floor of the box shows the curve's shadow.            Concept Check  This last part of the section is not about computing anything new. It is about reviewing the concepts we have just built. Everything below refers to the two applications developed so far using line integrals, in particular the length of a wire and its mass ,   where is again and is the case the arc length once more. Assume throughout that the thickness of the wire can be ignored.   Reading the two formulas   In and , what do , , , , , and represent?     Blank box with four labelled rows, for the meaning of a, b and t, of C and dt, of the velocity vector, and of the density.       The two line elements   Take two nearby points of the wire, the ones reached at the parameter values and . Write for the displacement from the first to the second, and for the length of the piece of wire joining them. Intuitively speaking, what do and represent, and what happens to and in the limit that produces them?   Two nearby points of a curve , at the parameter values and . The straight arrow is the displacement ; the thick piece of curve joining the same two points has length . The chord is straight and the arc is not, so the two differ but less and less as the points come together.   A curve with two nearby points, their position vectors from the origin, the chord vector between them, and the arc joining them.   A smooth curve rises across the first quadrant. Two points on it, reached at the parameter values t sub k minus one and t sub k, are joined to the origin by two thin position vectors, labeled r of t sub k minus one and r of t sub k. A green arrow runs straight from the first point to the second and is labeled delta r, the difference of the two position vectors. The piece of curve between the same two points is drawn thickly in orange and labeled delta s sub k. The straight arrow cuts across inside the bend of the curve, so it is visibly shorter than the arc.     c(t) = (2.9*cos(t), 1.7*sin(t))  t1 = 0.32  t2 = 1.18  P = c(t1)  Q = c(t2)  D = (Q[0]-P[0], Q[1]-P[1])  M = ((P[0]+Q[0])\/2, (P[1]+Q[1])\/2)       C       \\Delta s_k       \\Delta \\mathbf{r}          \\mathbf{r}(t_{k-1})    \\mathbf{r}(t_k)    t_{k-1}    t_k                  (Say which of the two is a number and which a vector, and what each one records about the step. Then take the limit in : divide by and let the points come together; do the same for the arc, using the fact that the ratio of arc to chord tends to . Which substitution from earlier in the section is this?)     Blank box in three rows, for the meaning of the vector and scalar line elements, for the limit of the displacement divided by the time step, and for the limit of the arc length of the step.       Units   If we use meters and kilograms as the units of length and mass respectively, then what will the units of and be?     Blank box with one row, for the units of the density, of the line element, and of their product.       What is being integrated?   In the above applications of line integrals of scalar functions , what is the scalar function that is being integrated (the integrand) along the wire?     Blank box with one row, for the integrand of the mass integral and the integrand of the length integral.       Two wires: the circle of radius centered at the origin, and the square inscribed in it, whose vertices lie on the circle.   A circle of radius two centered at the origin with a square inscribed in it, the square's four vertices lying on the circle.   A coordinate grid showing two closed curves. The first is a circle of radius two centered at the origin, passing through the marked point two comma zero. The second is a square inscribed in that circle, with horizontal and vertical sides and with its four vertices, at plus or minus root two in each coordinate, lying on the circle. The square's sides therefore cut across the inside of the circle.     R = 2  h = 1.4142135624       x^2+y^2=4       \\left(-\\sqrt{2},\\sqrt{2}\\right)       (2,0)     \\left(\\sqrt{2},\\sqrt{2}\\right)                   A mass with no parametrization   Assume that the density of the circular wire in is given by . Without parametrizing , find its mass.  (What is  along the curve ? Then the integrand is a constant, and what is left is the length of the wire.)     Blank box in two rows, for the value of the density along the circle and for the mass as that constant times the length.       Does the radius matter?   Assume that the mass density of a circular wire of radius centered at the origin is given by . Which statement is correct?    The mass of the wire is independent of its radius .    The mass of the wire increases as increases.    The mass of the wire decreases as decreases.    (Circle your choice and justify it: what is on the circle of radius , and what does that make ?)     Blank box with one row, for the density on the circle of radius R and the resulting mass.       Which wire is heavier?   Assume that the density of the square-shaped wire and of the circular wire graphed in is given by . Then, without parametrizing the curves, choose the correct option below. Which statement is correct?    The circular wire is heavier.    The square-shaped wire is heavier.    The two wires have the same mass.    (Circle your choice and justify it. On the circle, is constant, so its mass is that constant times its circumference. For the square you do not need the exact mass: the square is inscribed in the circle, so bound on the square from above and multiply by its perimeter. Is the bound strict?)     Blank box in three rows, for the mass of the circular wire, for the upper bound on the mass of the square wire, and for the conclusion.       A charged wire   Assume that the charge density of the square-shaped wire and of the circular wire graphed in is given by . Then, without parametrizing the curves, choose the correct option(s) below. Select all that apply.    The circular wire is negatively charged.    The square-shaped wire is positively charged.    In both cases (square and circular wires) the amount of positive charge is equal to the amount of negative charge.    (Draw the quarter of each wire lying in the first quadrant, where , together with the line , and mark where the density is positive and where it is negative. Now reflect in that line, that is, interchange and : what does the reflection do to each shape, to lengths, and to ? Conclude what the charge on that quarter is, and then on the whole wire.)     Empty first-quadrant grid running from zero to two and a half in each direction, for drawing the quarter of the circular wire, the quarter of the square wire, and the line y equals x.     Blank box in three rows, for the sign of the density on either side of the line y equals x, for the effect of the reflection on the density, and for the conclusion.       "
},
{
...
{
  "id": "assemblage-line-integral-results-4",
  "level": "2",
  "url": "sec-line-integrals.html#assemblage-line-integral-results-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Reading the two formulas   In and , what do , , , , , and represent?     Blank box with four labelled rows, for the meaning of a, b and t, of C and dt, of the velocity vector, and of the density.     "
},
{
  "id": "q-ds-dr",
  "level": "2",
...
},
{
  ...
  "number": "1.3.11",
  "title": "Units.",
  "body": " Units   If we use meters and kilograms as the units of length and mass respectively, then what will the units of and be?     Blank box with one row, for the units of the density, of the line element, and of their product.     "
},
{
  "id": "q-integrand",
  "level": "2",
  ...
  "body": " What is being integrated?   In the above applications of line integrals of scalar functions , what is the scalar function that is being integrated (the integrand) along the wire?     Blank box with one row, for the integrand of the mass integral and the integrand of the length integral.     "
},
{
...
},
{
  ...
  "body": " Does the radius matter?   Assume that the mass density of a circular wire of radius centered at the origin is given by . Which statement is correct?    The mass of the wire is independent of its radius .    The mass of the wire increases as increases.    The mass of the wire decreases as decreases.    (Circle your choice and justify it: what is on the circle of radius , and what does that make ?)     Blank box with one row, for the density on the circle of radius R and the resulting mass.     "
},
{
...
},
{
  ...
  "body": " Vector Fields and Line Integrals   In this section we meet two ideas. A vector field attaches a vector a magnitude and a direction to every point of the plane or of space; think of the velocity of the air at each point of a room, or the gravitational pull at each point around a planet. The line integral of a vector field then answers a natural question: as an object moves along a curve through the field, how much does the field push it along its way? The physical name for this accumulated push is work .     Vector Fields  What is a vector field? We will study the definition through an example. Assume that we have a function on : the function takes two real numbers as its input and outputs a vector in . As an example, consider the following vector field: To visualize this vector field, imagine that at each point there is a vector attached. Physically, this vector could correspond to the velocity of an atom located at the point . See .   The vector field . Every arrow points directly away from the origin, and the arrows get longer as the distance from the origin grows.   A grid of arrows all pointing away from the origin, growing longer farther from the origin.   The plane with x and y from minus 5 to 5. At each point of a regular grid a blue arrow points radially outward, directly away from the origin. Arrows near the origin are short; arrows near the edge of the picture are long. A red dot marks the origin, where the field is the zero vector.     F(x,y) = (0.22*x, 0.22*y)                           What is the length of the vector in ? Compute it, and use it to explain why the blue arrows in grow in length as we move away from the origin along a straight line. Then modify the vector field so that the length of the vectors is one at every point. (Dividing a vector by its own length produces a unit vector.)     Blank box in two rows, one for the length of the radial field's vectors and the reason the arrows grow, and one for the normalized field.    Visualized, the normalized field looks like : the directions are unchanged, but now all arrows have the same length.   The normalized field : same directions as , but every arrow has length one.   A grid of arrows all pointing away from the origin, all of the same length.   The plane with x and y from minus 5 to 5. At each point of a regular grid a blue arrow points radially outward, directly away from the origin, and every arrow has exactly the same length. A red dot marks the origin, where the field is undefined.      U(x,y) = (0.55*x\/sqrt(x^2+y^2+0.0001), 0.55*y\/sqrt(x^2+y^2+0.0001))                           Our next example is a vector field which is a function on . Consider the following vector field: This field has the same dependence on , and as the gravitational force exerted by a massive body located at the origin. The gravitational force exerted by a mass at the origin on a mass at the point is the gravitational force field  , where is the gravitational constant and the minus sign makes the force point back toward the origin. The field studied here is that force with the constant stripped off, so the two differ only by a positive factor and point the same way at every point. Every arrow points toward the origin. Compute in terms of to see how the pull weakens with distance. See . We will meet this field again in .     Blank box with one row, for the magnitude of the inverse-square field in terms of the distance from the origin and the law it obeys.     The field , which depends on , and exactly as the gravitational force does. All arrows point toward the origin and shrink with the square of the distance.   A three-dimensional grid of arrows all pointing toward the origin, longer near the origin.   A three-dimensional box with x, y, and z from minus 0.7 to 0.7. At each point of a coarse three-dimensional grid a blue arrow points directly toward the center of the box, where a red dot marks the origin. Arrows close to the origin are long; arrows at the corners of the box are short.         Work (Reminder)  Our goal is to study the line integral of a vector field over a curve , and we will do so using an example from physics: calculating the amount of work done by a force , which in general can be a function of , , and . Before we present the example, let us remind ourselves of the definition of work. Consider a box being pulled by a constant force , as shown in .   A box pulled by a constant force applied at an angle . The displacement is measured below the ground line, from the centre of mass of the box in its initial position to its centre of mass in the final position (the faint box). Only the component along the motion does work.   A box on a horizontal line pulled by a tilted force arrow, with the horizontal component of the force and the displacement marked.   A horizontal line represents the ground, with a small box sitting on it at the left. A red arrow labelled F points up and to the right from the top of the box, making an angle alpha with the horizontal; a small arc marks the angle. A shorter blue horizontal arrow labelled the magnitude of F times cosine alpha, times i, shows the horizontal component of the force. A faint second box to the right marks the final position. The centre of each box is marked with a dot, and a dashed vertical line drops from each centre to a dashed double-headed arrow drawn below the ground line and labelled delta x, so the displacement is measured from one centre of mass to the other.                \\mathbf{F}     \\alpha       \\left\\lVert\\mathbf{F}\\right\\rVert\\cos(\\alpha)\\,\\mathbf{i}           \\delta x                  The amount of work done by the force is equal to the magnitude of the force in the direction of motion, , multiplied by the amount of displacement : The last equality holds because the motion is in the -direction, which lets us rewrite as the dot product . This dot-product form is the one that generalizes: work is the dot product of the force with the displacement .     Work of a Force Field  Let us now consider the situation where a force is acting on an object and causing it to move along a curved trajectory from an initial point to a final point. Neither the force nor the direction of motion is constant anymore, so we cannot apply directly. Instead, we reuse the strategy of : calculate the work on small subarcs of the trajectory, where force and direction are nearly constant, and then sum up. shows one such subarc.   On the th subarc, of length , the direction of motion is the unit tangent vector (green) and the force is approximately (red). Only the tangential component of the force does work.   A curved trajectory with one short subarc highlighted, showing the force vector and the unit tangent vector at a point.   A black curve rises from a red point near the origin, bending upward to a red endpoint at the upper right. A short piece of the curve, labelled Delta s sub k, is drawn thicker in blue. At a black point on this piece, a red arrow labelled F of (x sub k, y sub k) points steeply up and to the right, and a shorter green arrow labelled T sub k points along the curve in the direction of motion.     q(t) = (t, 0.5+0.5*t^2)  tk = 0.52              \\Delta s_k         \\mathbf{F}(x_k,y_k)     \\mathbf{T}_k                  Build the work integral from the subarcs. (On the th subarc the displacement has length and direction , so the dot-product form of gives the work done along it. Sum over the subarcs and let . Then use to rewrite , which gives the compact form of the integral, and finally write everything in terms of a parametrization , .)     Blank box in five rows, for the work along one subarc, for the sum over subarcs, for the limit as a line integral, for rewriting T ds, and for the parametrized form of the integral.     The Line Integral of a Vector Field  The work done by along is approximated by and exactly by where is the unit tangent vector of the curve. Since the combination is simply , and In practice, once the curve is parametrized by for , evaluate the field along the curve, dot it with the velocity, and integrate over time.   The applet below carries every ingredient of at once: a curve parametrized by , the velocity tangent to it, and a force field evaluated at the moving point. Work out what the integrand is doing before you compute anything.   A point climbs the curve while the force field and the velocity are drawn at its current position. The work is the accumulated , so the angle between the two arrows is what decides its sign.     Work was our motivation, but any vector field can be integrated over a curve in this fashion; the number it produces is also called the circulation of along , a name that becomes the usual one when is a closed curve. shows the accumulation of along a trajectory.   As the object moves through the field along the trajectory, the work accumulates moment by moment from the tangential component of the force.    There is a third, frequently used way to write the same integral. Assume the vector field has components . Since , expanding the dot product gives the differential form of the line integral: All three notations , , and mean exactly the same thing.      Work along a twisted cubic   Calculate the work done by the force over the curve : from to .   Solution. (Use . Read the parameter interval off the two endpoints, write the force along the curve by substituting , ,  one component vanishes identically and differentiate for . Dot, expand, and integrate term by term. The curve is shown in .)     Blank box in four rows, for the parameter interval, for the force along the curve, for the velocity vector, and for the work integral.     The twisted cubic , , from the origin to . The dashed gray curve is its shadow on the plane .   A curve in space rising from the origin to the point (1,1,1), with its shadow on the floor.   A three-dimensional box with x, y, and z from 0 to 1.1. A thick blue curve starts at a red point at the origin, labelled (0,0,0), hugs the floor at first, then sweeps upward ever more steeply to a red point labelled (1,1,1) at the far upper corner. A dashed gray parabola on the floor shows the curve's shadow.            Work done by an inverse-square field along a helix   Calculate the line integral over the curve from to .   Solution. (This integral is in the differential form : identify and recognize it as the inverse-square field of . Read off the parameter interval from the endpoints. Along the helix, simplify first, then write and ; the dot product collapses. Integrate with the substitution . Say what the sign of the answer means physically, and check it against and .)     Blank box in five rows, for identifying the field and the parameter interval, for the field along the helix, for the velocity and the dot product, for the integral evaluated by substitution, and for the physical meaning of the sign.     The helix , , climbing through the field (orange arrows, direction only). At the same three points the velocity is drawn in green: at every one of them the field leans away from the direction of travel, which is why the work comes out negative.   One full turn of a helix rising from (1,0,0) to (1,0,2 pi), with arrows along it pointing toward the origin.   A three-dimensional box with x and y from minus 1.4 to 1.4 and z from 0 to 7. A thick blue helix makes one full counterclockwise turn of radius one, starting at a red point labelled (1,0,0), t equals 0, on the floor and ending at a red point labelled (1,0,2 pi), t equals 2 pi, directly above it. A dashed gray unit circle on the floor is the helix's shadow. Three orange arrows attached to points of the helix, labelled F, point inward and downward, toward the origin. At the same three points three green arrows, labelled v, point along the helix in the direction of travel, upward and around; each green arrow makes an obtuse angle with the orange one beside it.       A particle climbs the helix through the field while the work accumulates. Watch its sign, and check the value it reaches at the top against your answer.       The same endpoints, two paths, two answers   Calculate the work done by the force in moving a particle from to along each of the following two paths:    , the straight segment from to , parametrized by , ;     , the arc of the parabola from to , parametrized by , .      The two paths of drawn in the field : the segment along and the arc along , both running from to .   A straight segment and a parabolic arc, both joining the origin to the point one comma one, drawn in a field of arrows.   The first quadrant, with x and y running from zero to a little past one, carrying a grid of blue field arrows. Along the x axis they point straight up and along the y axis they point straight right, turning and lengthening in between. Two curves join the origin O to the point P at one comma one: a green straight segment labelled C 1 along the line y equals x, and a vermillion arc labelled C 2 following the parabola y equals x squared, which bows below the segment. Each curve carries an arrowhead pointing from O toward P.     F(x,y) = (0.11*y, 0.22*x)  c1(t) = (t, t)  c2(t) = (t, t^2)              C_1       C_2       O     P                    Solution. (Both curves start at and end at , as in , so any difference between the two answers can come only from the paths themselves. Apply to each: write along the path and the velocity, dot, and integrate. Compare and , and say what the comparison tells you about whether the endpoints alone determine the work. Which fields are the exception is the question taken up in .)     Blank box in three rows, for the work along the segment, for the work along the parabola, and for the conclusion about path dependence.          Concept Check   Positive, negative, or zero?   In , determine whether the work done by the force field along the two paths and is positive, negative, or zero.   Two closed paths in the radial field : the ellipse and the circle . Notice the orientation of each curve.   An ellipse and a circle centred at the origin, drawn in a field of arrows that point away from the origin, each curve carrying an arrowhead that gives its direction of travel.   The plane with x and y from minus 5 to 5, filled with blue arrows that point straight away from the origin and grow longer with the distance from it. A green ellipse crosses the x axis at plus and minus three and the y axis at plus and minus one; its arrowhead, just above the origin, points in the negative x direction, so the ellipse is traversed counterclockwise. A black circle of radius two is centred at the origin; its arrowhead, in the upper right, points down and to the right, so the circle is traversed clockwise. A red dot marks the origin, where the field is the zero vector.     F(x,y) = (0.22*x, 0.22*y)  c1(t) = (3*cos(t), sin(t))  c2(t) = (2*cos(t), -2*sin(t))              C_2       C_1                      (The field is the radial field , which aims straight away from the origin at every point. For the circle, ask what angle makes with the direction of travel at every point, and what that does to the integrand of . For the ellipse the integrand does not vanish: mark the stretches where the curve moves away from the origin and those where it moves back, decide the sign of on each, and think about what a full circuit adds up to. Does reversing the orientation change either answer?)     Blank box in three rows, for the sign of the work around the circle, for the sign on the outward and inward stretches of the ellipse and over a full circuit, and for the effect of reversing the orientation.       "
},
{
  "id": "fig-radial-field",
  "level": "2",
...
{
  "id": "subsec-vector-fields-8",
  "level": "2",
  "url": "sec-vector-fields.html#subsec-vector-fields-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "subsec-work-force-field-9",
  "level": "2",
  "url": "sec-vector-fields.html#subsec-work-force-field-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "circulation "
...
{
  "id": "subsec-work-force-field-11",
  "level": "2",
  "url": "sec-vector-fields.html#subsec-work-force-field-11",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Work done by an inverse-square field along a helix   Calculate the line integral over the curve from to .   Solution. (This integral is in the differential form : identify and recognize it as the inverse-square field of . Read off the parameter interval from the endpoints. Along the helix, simplify first, then write and ; the dot product collapses. Integrate with the substitution . Say what the sign of the answer means physically, and check it against and .)     Blank box in five rows, for identifying the field and the parameter interval, for the field along the helix, for the velocity and the dot product, for the integral evaluated by substitution, and for the physical meaning of the sign.     The helix , , climbing through the field (orange arrows, direction only). At the same three points the velocity is drawn in green: at every one of them the field leans away from the direction of travel, which is why the work comes out negative.   One full turn of a helix rising from (1,0,0) to (1,0,2 pi), with arrows along it pointing toward the origin.   A three-dimensional box with x and y from minus 1.4 to 1.4 and z from 0 to 7. A thick blue helix makes one full counterclockwise turn of radius one, starting at a red point labelled (1,0,0), t equals 0, on the floor and ending at a red point labelled (1,0,2 pi), t equals 2 pi, directly above it. A dashed gray unit circle on the floor is the helix's shadow. Three orange arrows attached to points of the helix, labelled F, point inward and downward, toward the origin. At the same three points three green arrows, labelled v, point along the helix in the direction of travel, upward and around; each green arrow makes an obtuse angle with the orange one beside it.       A particle climbs the helix through the field while the work accumulates. Watch its sign, and check the value it reaches at the top against your answer.     "
},
{
...
},
{
  ...
  "body": " Fundamental Theorem of Line Integrals   Let be a smooth curve joining the point to the point in the plane or in space and parametrized by . Let be a differentiable function with a continuous gradient vector on a domain containing . Then     (Parametrize by , , and write the line integral in the parametrized form with . Expand the dot product of the gradient with ; the chain rule turns the integrand into a single derivative with respect to , and the Fundamental Theorem of Calculus finishes the job.)     Blank box in three rows, for expanding the dot product of the gradient with the velocity, for recognizing the integrand as a derivative with respect to t by the chain rule, and for evaluating the integral.     "
},
{
...
},
{
  ...
  "number": "1.5.9",
  "title": "Example I.",
  "body": " Example I   Consider the scalar-valued function .     Calculate the gradient vector field .    Evaluate the line integral of the vector field over the curve parametrized as from to .    What is the result of from to where is the line connecting the two points?      Solution. (In A , write and take the three partial derivatives; you should recognize the field. In B , one way would be to parametrize, exactly as in ; instead use , which needs only the values of at the two endpoints. In C , say what tells you about without computing anything, and why. The two curves are shown in .)     Blank box in three labelled rows, for the gradient field, for the line integral along the helix by the fundamental theorem, and for the line integral along the segment with its justification.     "
},
{
...
},
{
  ...
  "number": "1.5.11",
  "title": "Example II.",
  "body": " Example II   Consider the vector field in the plane.     Find a function such that .    Use the solution of part (A) to calculate the line integral of along any curve from to .      Solution. (In A , match the two components of with and , one at a time. Step I: integrate the first with respect to , remembering that the constant of integration may depend on . Step II: differentiate what you have with respect to , compare with the second component, and solve for that function of . In B , say why applies to any curve from to , then evaluate. What happens to the arbitrary constant?)     Blank box in four rows, for integrating the first component with respect to x, for matching the second component to determine the function of y, for the potential function, and for the line integral by the fundamental theorem.     "
},
{
  ...
  "number": "1.5.12",
  "title": "Example III.",
  "body": " Example III   Consider the vector field .     Find a function such that .    Use the solution of part (A) to calculate the line integral from to .      Solution. (In A , match the three components one at a time. Step I: integrate the first with respect to ; the constant of integration may now depend on and . Step II: differentiate with respect to and compare with the second component; what does that say about the dependence on ? Step III: differentiate with respect to , compare with the third component, and solve. In B , apply with and .)     Blank box in five rows, for the three steps that match the components of the field to the partial derivatives of f, for the resulting potential function, and for the line integral by the fundamental theorem.     "
},
{
  ...
  "number": "1.5.13",
  "title": "Example IV.",
  "body": " Example IV   In we computed the work done by the inverse-square field   along the helix from to , by parametrizing the curve. Do it again with .   Solution. (First say why looking for a potential function is legitimate here: where is the field defined, and does the helix avoid that point? Rather than run the three steps of , notice that depends only on the distance , and that , and likewise for and . Guess and check with the chain rule. Then the work needs nothing but at the two endpoints. Compare with , and say what this calculation never used.)     Blank box in four rows, for the justification that a potential exists, for the gradient of one over rho, for the work from the endpoint values, and for the remark about path independence.     "
},
{
  ...
  "body": " Conservative Fields are Gradient Fields   Let be a vector field whose components are continuous throughout an open connected region in space ( ). Then is conservative if and only if is a gradient field for a differentiable function .    ( Gradient implies conservative : assume and apply to any piecewise smooth curve from to ; what does the answer depend on? Conservative implies gradient : fix a point of and define  as the line integral of from to along any curve in ; say why connectedness and path independence make this definition meaningful. To show , compare with by travelling along the straight segment from to , which lies in because is open; parametrize , so that the difference quotient becomes an average of over the segment, and let using the continuity of . The other two partials are the same argument.)     Blank box in five rows, for the easy direction of the proof, for the definition of the potential function as a line integral, for the difference of its values along a short segment, for the difference quotient and its limit, and for the remaining partial derivatives.     "
},
{
...
},
{
  ...
  "body": " Loop Property of Conservative Fields   The following statements are equivalent.      around every loop (that is, closed curve ) in .    The field is conservative on .       ( (2) implies (1) : split any loop as , with from to and from back to , as in . Reversing gives a second path from to ; what does path independence say about and , and how is related to ? Add up. (1) implies (2) : take any two paths , from to , build a loop out of them, and apply the assumption to it.)     Blank box in two rows, one for each direction of the proof of the loop property.     "
},
{
...
},
{
  ...
  "body": " Work Along the Helix, Two Ways   For the field and path of :    Use the parametrized path to compute the work done by the force field from point to point .    Is it possible to use the fundamental theorem of line integrals to compute that work? If so, use it to verify your answer to the previous part. Justify your answer fully.    (Read the parametrization and the field off , and find the parameter values of and . For part 1, write and , dot them, and integrate. For part 2, decide whether is conservative where is it defined, and can you find a potential function? and if so evaluate . Then explain, from the picture, why the two answers agree.)     Blank box in four rows, for the parameter values of the endpoints, for the direct computation of the work, for the fundamental-theorem computation with its justification, and for the geometric explanation.     "
},
{
...
},
{
  ...
  "body": " A Line Integral Along a Segment   Compute the line integral of the vector field along the line segment shown in .  (Read the field and the endpoints off . Before parametrizing anything, test whether the field is conservative, and look for a potential function by inspection. If you find one, the segment never needs to be parametrized.)     Blank box in three rows, for testing whether the field is conservative, for a potential function and its check, and for the line integral from the endpoint values.     "
},
{
  "id": "fig-vf-segment",
  "level": "2",
...
},
{
  ...
  "body": " The Same Endpoints, a Wilder Path   Compute the line integral of the vector field from point to point as shown in , where the curve is parametrized as   (First check the endpoints: evaluate and and compare with . Then decide whether you need to differentiate at all, and say why. Compare your answer with .)     Blank box in two rows, for the two endpoints of the curve and for the value of the line integral with its justification.     "
},
{
  "id": "fig-vf-curve",
  "level": "2",
...
},
{
  ...
  "body": " Double and Iterated Integrals Over Rectangles  Before we begin discussing the actual topic of today's lecture, we will briefly remind ourselves of the concept of area under a function and its relation with definite integrals.    Reminder: Area Under from to  As shown in , to calculate the area under from to , we divide the interval into subintervals and then let the number of subintervals (which is the same as the number of rectangles) approach infinity. Write the area as such a limit, and then as the definite integral it defines.     Blank box in two rows, one for the area as a limit of a sum of rectangle areas and one for the definite integral as the same limit.     The area under from to , approximated by rectangles of width . The height of the -th rectangle is , where is a sample point in the -th subinterval. As , the total area of the rectangles approaches the area under the curve.   The area under a curve approximated by eight rectangles.    f(t) = (t, 0.15*(t-1)*(t-3)*(t-5) + 2.5)              a    b    \\Delta x       x_i^*       \\text{height} = f(x_i^*)   y = f(x)                    Double Integrals Over Rectangles  As we will see, double integrals can be interpreted geometrically as the volume under a surface . As an example, consider the surface over the region   drawn in . The solid we are after stands on top of and stops at the surface: its floor is the shaded square in the -plane, its ceiling is the piece of the surface lying directly above , outlined in dashed black, and the dashed vertical segments above the four corners of are its vertical edges. Computing the volume of that solid the volume on top of the region of integration and below the surface is the goal of this section. Its ceiling is curved, so no formula from solid geometry gives the answer, and we fall back on the idea of : estimate the volume with pieces whose volume we do know, then refine.   The volume this section sets out to compute: the solid above the region of integration and below the surface . The shaded square is , the dashed black curve is the outline of the top of the solid on the surface, and the dashed vertical segments are the edges of the solid above the four corners of .     To estimate that volume, use the point in the middle of to find the height of a single cuboid standing on , and compute this (very bad) estimate of the desired volume.     Blank box with one row, for the one-box estimate of the volume.     A first, very rough estimate of the volume under over the square : a single cuboid whose height is sampled at the center of the square. Turn the picture around: seen from any direction, part of the box sticks out above the surface and part of the volume under the surface is left uncovered.     We can improve the estimate by splitting the region into more squares. Split into four squares, sample at the center of each, and add up the four cuboids, as shown in . Similar to finding the area under , if we let the number of splittings go to infinity, our estimation becomes exact, i.e., we find the exact desired volume. The refinement process is animated in .     Blank box in two rows, one for the four sampled heights and one for the four-box estimate of the volume.     Splitting into four squares improves the estimate. Each cuboid uses the value of at the center of its square. Turn the picture around: each box now has to match the surface over a quarter of instead of over all of it, as the single box of does.      A Riemann sum for a double integral, to explore: the region of integration, the surface , and the grid of boxes built over it. Refining the grid drives the sum toward .     Write the approximation of the volume in Riemann-sum notation, using divisions in and in , and then the exact volume as a limit. (Each box contributes its base area times the height of the surface at a sample point.)     Blank box in two rows, one for the double Riemann sum approximating the volume and one for its limit.     The Double Integral Over a Rectangle  The result of the above limit is defined as the double integral over a rectangular region and is denoted as    For instance, in the example above, write the volume as a double integral, with its limits.     Blank box with one row, for the volume of the example written as a double integral with limits.    Next, we will study how to calculate such integrals.   Animation of the Riemann-sum definition of the double integral. The region is split into , then , then , then squares, and a cuboid is built over each square with height sampled at its center. The displayed estimate approaches the exact volume, which you will compute in .       Calculating Double Integrals as Iterated Integrals   Example I   Calculate the double integral .   Solution. (Integrate with respect to first, treating as a constant and using FTC II; the result is a function of . Then integrate that with respect to .)     Blank box in two rows, one for the inner integral with respect to x and one for the outer integral with respect to y.      In calculating double integrals, the following theorem can be very useful.   Fubini's Theorem (First Form)   If is continuous throughout the rectangular region , then     Therefore, if the integrand satisfies the conditions of , we can change the order of integration as in . Check this on the previous example: integrate over first, then over , and compare with the result of .     Blank box in two rows, one for the inner integral with respect to y and one for the outer integral with respect to x.       An Iterated Integral Requiring Substitution and Integration by Parts   Example II   Calculate the double integral .   Solution. (By you may integrate over first, with held constant; the substitution does it. The result is a function of involving a logarithm, which needs integration by parts, ; in the leftover integral, write the numerator as . The surface is shown in .)     Blank box in three rows, for the inner integral by substitution, for the antiderivative of the logarithm by parts, and for the value of the double integral.       The surface over the rectangle , . The double integral of is the volume between this surface and the shaded base rectangle.   A curved surface over a rectangle in the plane, highest along one edge.  Three coordinate axes in space with a curved surface over the rectangle zero to one in x and zero to two in y. The surface rises from height zero along the y z plane to height one at the corner x equals one, y equals zero, and slopes downward as y increases. The base rectangle in the x y plane is shaded.       Concept Check  The questions below are about setting up double integrals, not about evaluating them. Throughout, is the square   Each figure can be rotated: drag the background to turn it, and scroll to zoom. In the first three figures the light blue segments at the corners of join the region of integration to the surface above it, the way the dashed drops do in .   A volume under a sphere   Write down a double integral for computing the volume inside the sphere and above the region . See .  (Which half of the sphere is the ceiling, and is its formula defined on all of ? The solid is the one of with a different ceiling.)     Blank box with one row, for the double integral with limits giving the volume under the sphere.       Figure (1): the part of the sphere lying above the square . The four light blue segments join the corners of to the sphere above them.     Signs, without computing   Assume that is the square of and choose all the correct statements below. Remember to justify your answers. Note that and are helpful in answering this question.          (Circle the correct statements and justify each. Where does the plane lie above the -plane over , and where below? What does the symmetry of about the line do to the two signed volumes? Then treat the same way, using .)     Blank box in two rows, for the sign of the integral of x over the square with its justification, and for the sign of the integral of y minus x with its justification.       Figure (2): the plane over the square , together with itself in the -plane. Half of the plane lies above and half below.      Figure (3): the plane over the square . It meets the -plane along the diagonal of .      The volume cut off by   Write a double integral for computing the volume of the region bounded by the blue plane and the orange plane as graphed in .  (Volume is unsigned, so the integrand is the distance between the two planes, not the signed height. How does this differ from ?)     Blank box with one row, for the double integral giving the volume between the plane z equals x and the square.       The volume cut off by   Write a double integral for computing the volume of the region bounded by the blue plane and the orange plane as graphed in .  (As before, the integrand is the distance between the two planes. The diagonal splits into two halves; what does the symmetry noted in let you do with the absolute value?)     Blank box with one row, for the double integral giving the volume between the plane z equals y minus x and the square.       "
},
{
...
},
{
  ...
  "number": "2.1.3",
  "title": "",
  "body": " A first, very rough estimate of the volume under over the square : a single cuboid whose height is sampled at the center of the square. Turn the picture around: seen from any direction, part of the box sticks out above the surface and part of the volume under the surface is left uncovered.    "
},
{
  ...
  "number": "2.1.4",
  "title": "",
  "body": " Splitting into four squares improves the estimate. Each cuboid uses the value of at the center of its square. Turn the picture around: each box now has to match the surface over a quarter of instead of over all of it, as the single box of does.    "
},
{
...
{
  "id": "assemblage-double-integral-def-2",
  "level": "2",
  "url": "section-double-integrals-rectangles.html#assemblage-double-integral-def-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.1.6",
  "title": "",
  "body": " Animation of the Riemann-sum definition of the double integral. The region is split into , then , then , then squares, and a cuboid is built over each square with height sampled at its center. The displayed estimate approaches the exact volume, which you will compute in .   "
},
{
  ...
  "number": "2.1.7",
  "title": "Example I.",
  "body": " Example I   Calculate the double integral .   Solution. (Integrate with respect to first, treating as a constant and using FTC II; the result is a function of . Then integrate that with respect to .)     Blank box in two rows, one for the inner integral with respect to x and one for the outer integral with respect to y.     "
},
{
  "id": "thm-fubini",
  "level": "2",
...
},
{
  ...
  "number": "2.1.9",
  "title": "Example II.",
  "body": " Example II   Calculate the double integral .   Solution. (By you may integrate over first, with held constant; the substitution does it. The result is a function of involving a logarithm, which needs integration by parts, ; in the leftover integral, write the numerator as . The surface is shown in .)     Blank box in three rows, for the inner integral by substitution, for the antiderivative of the logarithm by parts, and for the value of the double integral.     "
},
{
  ...
  "number": "2.1.10",
  "title": "",
  "body": " The surface over the rectangle , . The double integral of is the volume between this surface and the shaded base rectangle.   A curved surface over a rectangle in the plane, highest along one edge.  Three coordinate axes in space with a curved surface over the rectangle zero to one in x and zero to two in y. The surface rises from height zero along the y z plane to height one at the corner x equals one, y equals zero, and slopes downward as y increases. The base rectangle in the x y plane is shaded.    "
},
{
  ...
  "body": " A volume under a sphere   Write down a double integral for computing the volume inside the sphere and above the region . See .  (Which half of the sphere is the ceiling, and is its formula defined on all of ? The solid is the one of with a different ceiling.)     Blank box with one row, for the double integral with limits giving the volume under the sphere.     "
},
{
...
},
{
  ...
  "body": " The volume cut off by   Write a double integral for computing the volume of the region bounded by the blue plane and the orange plane as graphed in .  (Volume is unsigned, so the integrand is the distance between the two planes, not the signed height. How does this differ from ?)     Blank box with one row, for the double integral giving the volume between the plane z equals x and the square.     "
},
{
  ...
  "body": " The volume cut off by   Write a double integral for computing the volume of the region bounded by the blue plane and the orange plane as graphed in .  (As before, the integrand is the distance between the two planes. The diagonal splits into two halves; what does the symmetry noted in let you do with the absolute value?)     Blank box with one row, for the double integral giving the volume between the plane z equals y minus x and the square.     "
},
{
  ...
  "body": " Double Integrals Over General Regions and Area by Double Integration  Here we will generalize our last session's discussion about double integrals and how they can be used to evaluate volumes. Last session we restricted ourselves to shapes with rectangular base. Today we will look at more general shapes for the base.    Case I: Regions of the Form   Example I   Calculate the following double integral,   where .   Solution. (The region is shown in . For each fixed , runs from the lower curve to the upper curve, so integrate along the vertical strips first: write the iterated integral with its limits, do the inner integral, and then the outer one.)     Blank box in three rows, for the iterated integral with its limits, for the inner integral, and for the outer integral.       The region of , bounded above by and below by for . For each fixed , the inner integral runs along a vertical strip from the lower curve to the upper curve.   A region between an upper and a lower curve, with vertical strips.    f1(t) = (t, t^3 + 1)  f2(t) = (t, -2*t^2 + 2*t)  f1sc(t) = t^3 + 1  f2sc(t) = -2*t^2 + 2*t            f_1(x) = x^3 + 1  f_2(x) = -2x^2 + 2x   0    1                   Case II: Regions of the Form   Example II   Calculate the following double integral,   where .   Solution. (The region is shown in . This time, for each fixed , runs along a horizontal strip from the left curve to the right curve, so integrate with respect to first.)     Blank box in three rows, for the iterated integral with its limits, for the inner integral, and for the outer integral.       The region of , bounded on the left by and on the right by for . For each fixed , the inner integral runs along a horizontal strip from the left curve to the right curve.   A region between a left and a right curve, with horizontal strips.    g1(t) = (t^2, t)  g2(t) = (t^(1\/3), t)            g_1(y) = y^2  g_2(y) = y^{1\/3}   y = 0.5    y = 0.1                The idea behind both cases sweeping a strip across the region while the inner integral measures the length of the strip is animated in .   Animation of iterated integration over a general region. For the region of , a vertical strip at position has height ; as the strip sweeps from to , the outer integral accumulates the strip contributions. Use it to check your answer to that example.       Volume of a Tetrahedron   Example III   Find the volume of the tetrahedron bounded by the planes , , and .   Solution. ( shows the tetrahedron. First find the region of integration, the base of the tetrahedron in the -plane: sketch it on , with the lines that bound it and a typical vertical strip, and describe it in the form of Case I. Then the volume is the integral over that region of the height of the top plane, solved for . Set up the iterated integral and evaluate.)     Blank box in three rows, for the description of the base region, for the height of the top plane and the double integral, and for its evaluation.       The tetrahedron bounded by the planes (slanted face), (vertical face through the -axis), (the -plane) and (the base). Its vertices are , , and .   A tetrahedron with one vertex at the origin, bounded by a slanted plane and a vertical plane.  Three coordinate axes in space with a tetrahedron drawn in translucent blue. One vertex is at the origin, one at height two on the z axis, one at zero one zero on the y axis, and one at the point one comma one half comma zero. The slanted face x plus two y plus z equals two and the vertical face x equals two y are labeled with arrows.      Sketch the region of integration for : the base of the tetrahedron in the -plane, with the lines that bound it and a typical vertical strip.    Empty coordinate grid, marked at one half and one on each axis, for sketching the base of the tetrahedron and a vertical strip.     Why not integrate in the reverse order?  We could also try to integrate with respect to first, using horizontal strips. However, as the figure below shows, the right end of a horizontal strip depends on where the strip is: for the strip ends on the line , while for it ends on the line (that is, ). We would therefore have to split the region into two pieces and evaluate two double integrals, so integrating with respect to first is the more efficient choice here.    The same triangle swept by horizontal arrows for the reversed order of integration.    top(t) = (t, 1 - t\/2)  bot(t) = (t, t\/2)  topsc(t) = 1 - t\/2  botsc(t) = t\/2              \\left(1,\\tfrac12\\right)    y = \\tfrac12   x = 2 - 2y  x = 2y   0                   Area by Double Integration  In the previous session, we talked about finding the double integral and how it corresponds to the volume of an object with base and height . This session, we will look at a special case of this double integral, which corresponds to the area of region :    Example IV   Calculate the area of the region shown in , bounded on the right by , on the left by , and by the parabola .   Solution. ( Method 1. Split at the -axis into below and above, as in , and describe each with horizontal strips; on the left boundary is the parabola, solved for . Then the area is over each piece; the two outer integrals can be combined before evaluating.)     Blank box in two rows, one for the descriptions of the two subregions and one for the area computed as the sum of two iterated integrals.    ( Method 2, using symmetry. The curve is odd, so rotating it by about the origin maps it onto itself. In , which piece does that rotation carry onto which? Swap them, so that the region becomes the unit square together with the strip between the parabola and the -axis, and add the two areas.)     Blank box in two rows, one for the symmetry argument and one for the area as the square plus the strip.       Method 2: since is odd, the piece removed from the unit square (below the -axis) is congruent to the piece added to the right of the -axis (above it). The area is therefore the area of the square plus the area of the green strip between the parabola and the -axis.   The region decomposed into a unit square and two matching pieces.    right(t) = (t - t^3, t)  leftR2(t) = (sqrt(t) - 1, t)             \\text{area } 1    A    A    \\tfrac13   x = y - y^3  y = (x+1)^2                The region of , split into (below the -axis) and (above it). Both subregions share the right boundary ; the left boundary is the vertical line for and the parabola for .   A region split into two stacked parts R 1 and R 2.    right(t) = (t - t^3, t)  leftR1(t) = (-1, t)  leftR2(t) = (sqrt(t) - 1, t)          x = y - y^3  y = (x+1)^2   R_1    R_2    -1    -1                   Concept Check  Both problems below ask only for a setup : a double integral whose value is the volume or the area in question, with a region of integration that is no longer a rectangle. Each figure can be rotated by dragging the background, and zoomed by scrolling.   A ball cut by a cylinder   Set up a double integral for computing the volume of the region bounded by the cylinder and the sphere . See .  (The solid is the part of the ball inside the cylinder: what are its floor and ceiling, and so its height over a point of the shadow? The region of integration is the shadow of the solid, the set of points inside both circles and ; find where the circles cross, and describe the region as in .)     Blank box in three rows, for the height of the solid, for the crossing points and the description of the region of integration, and for the double integral with limits.       Figure (4): the sphere and the cylinder . Use this graph to find the region of integration and the integrand. The wall of the cylinder runs straight down to the -plane, where the red circle outlines the region of integration.     Problem: an area as a double integral   Set up a double integral for computing the area of the region bounded by the blue curve and the red curve, which are graphed in .  (Identify the two curves: the red one as in terms of , and the blue one as an arc of a circle whose radius you can read off the endpoints. Slice the region horizontally; note that the right end of a slice changes when passes , so two integrals are needed. Set them up using . Then look at what comes out: one integrand is odd, and what remains is a familiar area.)     Blank box in three rows, for the equations of the two curves, for the area as two iterated integrals, and for the value with its explanation.       Figure (5): the region bounded by the blue arc of the circle and the red curve . The two curves meet at and , which are opposite ends of a diameter; the dashed arc is the rest of the circle.   A tilted circle with solid and dashed halves bounding the shaded region.    R = sqrt(1 + pi^2\/4)  arcsine(u) = (sin(u), u)  circ(t) = (R*cos(t), R*sin(t))         \\left(1,\\tfrac{\\pi}{2}\\right)    \\left(-1,-\\tfrac{\\pi}{2}\\right)   y=\\sin^{-1}(x)  x^2+y^2=1+\\tfrac{\\pi^2}{4}   D                   "
},
{
  ...
  "number": "2.2.1",
  "title": "Example I.",
  "body": " Example I   Calculate the following double integral,   where .   Solution. (The region is shown in . For each fixed , runs from the lower curve to the upper curve, so integrate along the vertical strips first: write the iterated integral with its limits, do the inner integral, and then the outer one.)     Blank box in three rows, for the iterated integral with its limits, for the inner integral, and for the outer integral.     "
},
{
...
},
{
  ...
  "number": "2.2.5",
  "title": "",
  "body": " Animation of iterated integration over a general region. For the region of , a vertical strip at position has height ; as the strip sweeps from to , the outer integral accumulates the strip contributions. Use it to check your answer to that example.   "
},
{
  ...
  "number": "2.2.6",
  "title": "Example III.",
  "body": " Example III   Find the volume of the tetrahedron bounded by the planes , , and .   Solution. ( shows the tetrahedron. First find the region of integration, the base of the tetrahedron in the -plane: sketch it on , with the lines that bound it and a typical vertical strip, and describe it in the form of Case I. Then the volume is the integral over that region of the height of the top plane, solved for . Set up the iterated integral and evaluate.)     Blank box in three rows, for the description of the base region, for the height of the top plane and the double integral, and for its evaluation.     "
},
{
...
},
{
  ...
  "number": "2.2.8",
  "title": "",
  "body": " Sketch the region of integration for : the base of the tetrahedron in the -plane, with the lines that bound it and a typical vertical strip.    Empty coordinate grid, marked at one half and one on each axis, for sketching the base of the tetrahedron and a vertical strip.   "
},
{
...
},
{
  ...
  "number": "2.2.10",
  "title": "Example IV.",
  "body": " Example IV   Calculate the area of the region shown in , bounded on the right by , on the left by , and by the parabola .   Solution. ( Method 1. Split at the -axis into below and above, as in , and describe each with horizontal strips; on the left boundary is the parabola, solved for . Then the area is over each piece; the two outer integrals can be combined before evaluating.)     Blank box in two rows, one for the descriptions of the two subregions and one for the area computed as the sum of two iterated integrals.    ( Method 2, using symmetry. The curve is odd, so rotating it by about the origin maps it onto itself. In , which piece does that rotation carry onto which? Swap them, so that the region becomes the unit square together with the strip between the parabola and the -axis, and add the two areas.)     Blank box in two rows, one for the symmetry argument and one for the area as the square plus the strip.     "
},
{
...
},
{
  ...
  "number": "2.3.5",
  "title": "Example I.",
  "body": " Example I   Replace the following polar equations by equivalent Cartesian equations.           Solution. (Use . Parts A and B are one line each; name the curves. In C , regroup the left side as a product of two familiar quantities. In D , replace and , then square to remove the root. Compare with .)     Blank box in four labelled rows, one for the Cartesian form of each of the four polar equations.     "
},
{
...
},
{
  ...
  "body": " Double Integrals in Polar Form  In the previous session, we talked about a new coordinate system known as polar coordinates. Today, we will use polar coordinates to calculate double integrals. As you will see, this set of coordinates can sometimes simplify our calculations. In Cartesian coordinates, double integrals are of the form ,     How Does a Double Integral Look in Polar Coordinates?  To answer this question, assume that our region of integration is   which is shown on the left in . We divide this region into polar rectangles as shown on the right. Then, we calculate the area of a typical polar rectangle   Compute this area. (The area of a sector of a circle with radius and central angle is ; the polar rectangle is the difference of two sectors. Factor the difference of squares and write the result in terms of , , and the average radius . Then write the Riemann sum for with these cells and pass to the limit.)     Blank box in three rows, for the area of a polar rectangle, for the Riemann sum over polar rectangles, and for the resulting polar form of the double integral.     Double Integrals in Polar Coordinates  The area of a polar rectangle with average radius is so that , and     On the left, the region . On the right, divided into polar rectangles; the highlighted polar rectangle has area , where is its center.    A washer-slice region between two radii and two angles.    outer(t) = (2.4*cos(t), 2.4*sin(t))  inner(t) = (1.1*cos(t), 1.1*sin(t))            R   r = b  r = a   \\theta = \\beta    \\theta = \\alpha    O               The washer slice divided into small polar rectangles, one highlighted.    a1(t) = (1.1*cos(t), 1.1*sin(t))  a2(t) = (1.425*cos(t), 1.425*sin(t))  a3(t) = (1.75*cos(t), 1.75*sin(t))  a4(t) = (2.075*cos(t), 2.075*sin(t))  a5(t) = (2.4*cos(t), 2.4*sin(t))                  R_{ij}   (r_i^*, \\theta_j^*)    O               The subdivision of into polar rectangles, and how the area of a polar rectangle behaves as the grid is refined, is animated in .   Animation of the polar area element. The region is divided into finer and finer polar rectangles; a highlighted cell has area exactly , and the sum equals the area of at every stage.       Integrating Over a Half Annulus   Example I   Evaluate , where is the region in the upper half plane bounded by the circles and .   Solution. (Sketch the region, shown in , and describe it in polar coordinates. Convert the integrand with , remember the factor in , integrate in first, and use the half-angle identity for in the outer integral.)     Blank box in three rows, for the polar description of the region, for the polar iterated integral, and for its evaluation.       The region of : the upper half of the annulus between the circles and .   The upper half of an annulus between radii one and two.    outer(t) = (2*cos(t), 2*sin(t))  inner(t) = (cos(t), sin(t))        R   x^2+y^2 = 4  x^2+y^2 = 1   1    2                  Area Enclosed by One Loop of a Rose   Example II   Use a double integral to find the area enclosed by one loop of the four-leaved rose , graphed in .   Solution. (Describe the colored loop of in polar coordinates: which angles sweep it, and for each such angle, from where to where does run? Then the area is in polar form; the half-angle identity handles .)     Blank box in two rows, one for the polar description of the loop and one for the area integral and its evaluation.       The four-leaved rose , with one loop shaded. Which angles sweep it out?   A four-leaved rose with one petal outlined and shaded.    rose(t) = (cos(2*t)*cos(t), cos(2*t)*sin(t))  loop(t) = (cos(2*t)*cos(t), cos(2*t)*sin(t))          D    \\theta = \\tfrac{\\pi}{4}    \\theta = -\\tfrac{\\pi}{4}                   A Volume Computed in Polar Coordinates   Example III   Find the volume of the solid that lies under the paraboloid , above the -plane, and inside the cylinder .   Solution. (Complete the square to see what the cylinder's cross-section is; the base disk is shown in and the solid in . Convert to polar form and solve for ; that gives the upper limit of , and the disk is swept by . Integrate the height of the paraboloid over the disk. The outer integral involves : use the half-angle identity twice, and use symmetry to halve the interval.)     Blank box in three rows, for the polar form of the cylinder and the description of the base disk, for the polar volume integral, and for its evaluation.       The base of the solid in : the disk inside the cylinder .   A disk of radius one centered at (1,0), passing through the origin.    circ(t) = (1 + cos(t), sin(t))       1    2    D    (x-1)^2 + y^2 = 1 \\text{ (or } r = 2\\cos\\theta)    0               The solid of : the region under the paraboloid , above the -plane, and inside the cylinder .   A paraboloid rising inside an off-center vertical cylinder above the plane.  Three coordinate axes in space with a vertical circular cylinder of radius one centered on the line x equals one, y equals zero. Inside the cylinder, the paraboloid z equals x squared plus y squared rises from the origin; the solid between the x y plane and the paraboloid, inside the cylinder, is the region whose volume is computed. Dashed lines mark the base circle.        An Integral That Needs Polar Coordinates   Example IV   Calculate the double integral , where is the unit disk centered at the origin.   Hint: Notice that you cannot solve this integral using Cartesian coordinates.   Solution. (Describe the unit disk in polar coordinates and convert the integrand. The extra factor of in is exactly what makes the inner integral computable: which substitution?)     Blank box for converting the integral to polar form and evaluating it.        Concept Check  Each question below asks for a setup in polar coordinates. Recall from that , , and from that , so that the double integral takes the polar form .  The work is almost entirely in the limits: which values of sweep the region, and for each such , between which two values of does the ray at that angle enter and leave the region. Two of the figures below carry a slider for so you can watch the ray move.   Three areas   Set up three (not more than three) integrals that correspond to the following areas graphed in :   the red-colored area,  the blue-colored area,  the sum of the areas in (1) and (2).   (Which angles sweep both regions? Write the vertical line and the two arcs in polar form; along a ray, where does each region begin and end? The third integral should need no line at all: what region is the union, and what does that give you to check the first two against?)     Blank box in four rows, for the polar forms of the boundary curves and for the three area integrals.       Figure (1): two regions between the circles and , cut apart by the vertical line and swept by the angles . The line is the ray , and it meets exactly on the outer circle.   Two semicircles, a slanted line, and two vertical lines bounding two shaded regions.    inner(t) = (cos(t), sin(t))  outer(t) = (2*cos(t), 2*sin(t))             \\left(1,\\sqrt3\\right)     \\theta = \\pi\/3  r=1  r=2  x=1  x=2  1  2                    Mass of a piece of a rose   Region is the region inside  and inside  . See . Set up a double integral for computing the mass of a planar object that occupies region and whose density is given by .   Hint : note that as varies, you may need to modify the limits of accordingly.  (Write the density and in polar form first; something cancels. Then the limits: take the petal around , which is traced for , and slide the ray in . Near which curve does the ray leave at, and near the edges of the petal which one? Find the changeover angle, write the integral for one petal, and use the congruence of the three petals.)     Blank box in four rows, for the density times the area element in polar form, for the two ranges of theta with their upper limits of r, for the mass of one petal, and for the total mass.       Figure (2): the rose and the circle . Drag the slider to turn the ray of angle ; the dots mark where that ray crosses each curve, which is what fixes the limits of .     The ball and the cylinder again, in polar   Set up a double integral (in polar coordinates) for computing the volume of the region bounded by the cylinder and the sphere . See .  (This is again. The height over a point of the region is unchanged; write it in terms of . Put both boundary circles in polar form and find the angles where they cross. For which is the sphere the binding constraint, and for which the cylinder? Use the symmetry about the -axis, and compare the region of integration with the one you described in Cartesian coordinates.)     Blank box in three rows, for the height and the polar forms of the two circles with their crossing angles, for the two ranges of theta with their upper limits, and for the volume as polar integrals.       The overlap of two cardioids   Set up integral(s) for computing the area of the overlap of the two curves and . See .  (A point lies in the overlap when its is at most both radii, so along each ray the region runs from out to the smaller of the two. Where do the cardioids cross, and which radius is the smaller one on each side of the crossing? Slide the ray in to see. Set up one integral for each range of , and say what symmetry relates the two.)     Blank box in three rows, for the crossing angles and which radius is smaller where, for the area as a sum of polar integrals, and for the symmetry between the two pieces.       Figure (4): the cardioids and . Drag the slider to turn the ray of angle ; the overlap is what the ray reaches before it leaves the first of the two curves.     "
},
{
...
},
{
  ...
  "number": "2.4.3",
  "title": "Example I.",
  "body": " Example I   Evaluate , where is the region in the upper half plane bounded by the circles and .   Solution. (Sketch the region, shown in , and describe it in polar coordinates. Convert the integrand with , remember the factor in , integrate in first, and use the half-angle identity for in the outer integral.)     Blank box in three rows, for the polar description of the region, for the polar iterated integral, and for its evaluation.     "
},
{
  ...
  "number": "2.4.4",
  "title": "",
  "body": " The region of : the upper half of the annulus between the circles and .   The upper half of an annulus between radii one and two.    outer(t) = (2*cos(t), 2*sin(t))  inner(t) = (cos(t), sin(t))        R   x^2+y^2 = 4  x^2+y^2 = 1   1    2              "
},
{
  ...
  "number": "2.4.5",
  "title": "Example II.",
  "body": " Example II   Use a double integral to find the area enclosed by one loop of the four-leaved rose , graphed in .   Solution. (Describe the colored loop of in polar coordinates: which angles sweep it, and for each such angle, from where to where does run? Then the area is in polar form; the half-angle identity handles .)     Blank box in two rows, one for the polar description of the loop and one for the area integral and its evaluation.     "
},
{
  ...
  "number": "2.4.6",
  "title": "",
  "body": " The four-leaved rose , with one loop shaded. Which angles sweep it out?   A four-leaved rose with one petal outlined and shaded.    rose(t) = (cos(2*t)*cos(t), cos(2*t)*sin(t))  loop(t) = (cos(2*t)*cos(t), cos(2*t)*sin(t))          D    \\theta = \\tfrac{\\pi}{4}    \\theta = -\\tfrac{\\pi}{4}               "
},
{
  ...
  "number": "2.4.7",
  "title": "Example III.",
  "body": " Example III   Find the volume of the solid that lies under the paraboloid , above the -plane, and inside the cylinder .   Solution. (Complete the square to see what the cylinder's cross-section is; the base disk is shown in and the solid in . Convert to polar form and solve for ; that gives the upper limit of , and the disk is swept by . Integrate the height of the paraboloid over the disk. The outer integral involves : use the half-angle identity twice, and use symmetry to halve the interval.)     Blank box in three rows, for the polar form of the cylinder and the description of the base disk, for the polar volume integral, and for its evaluation.     "
},
{
  ...
  "number": "2.4.8",
  "title": "",
  "body": " The base of the solid in : the disk inside the cylinder .   A disk of radius one centered at (1,0), passing through the origin.    circ(t) = (1 + cos(t), sin(t))       1    2    D    (x-1)^2 + y^2 = 1 \\text{ (or } r = 2\\cos\\theta)    0             "
},
{
...
},
{
  ...
  "number": "2.4.10",
  "title": "Example IV.",
  "body": " Example IV   Calculate the double integral , where is the unit disk centered at the origin.   Hint: Notice that you cannot solve this integral using Cartesian coordinates.   Solution. (Describe the unit disk in polar coordinates and convert the integrand. The extra factor of in is exactly what makes the inner integral computable: which substitution?)     Blank box for converting the integral to polar form and evaluating it.     "
},
{
...
},
{
  ...
  "body": " Mass of a piece of a rose   Region is the region inside  and inside  . See . Set up a double integral for computing the mass of a planar object that occupies region and whose density is given by .   Hint : note that as varies, you may need to modify the limits of accordingly.  (Write the density and in polar form first; something cancels. Then the limits: take the petal around , which is traced for , and slide the ray in . Near which curve does the ray leave at, and near the edges of the petal which one? Find the changeover angle, write the integral for one petal, and use the congruence of the three petals.)     Blank box in four rows, for the density times the area element in polar form, for the two ranges of theta with their upper limits of r, for the mass of one petal, and for the total mass.     "
},
{
...
},
{
  ...
  "body": " The ball and the cylinder again, in polar   Set up a double integral (in polar coordinates) for computing the volume of the region bounded by the cylinder and the sphere . See .  (This is again. The height over a point of the region is unchanged; write it in terms of . Put both boundary circles in polar form and find the angles where they cross. For which is the sphere the binding constraint, and for which the cylinder? Use the symmetry about the -axis, and compare the region of integration with the one you described in Cartesian coordinates.)     Blank box in three rows, for the height and the polar forms of the two circles with their crossing angles, for the two ranges of theta with their upper limits, and for the volume as polar integrals.     "
},
{
  ...
  "body": " The overlap of two cardioids   Set up integral(s) for computing the area of the overlap of the two curves and . See .  (A point lies in the overlap when its is at most both radii, so along each ray the region runs from out to the smaller of the two. Where do the cardioids cross, and which radius is the smaller one on each side of the crossing? Slide the ray in to see. Set up one integral for each range of , and say what symmetry relates the two.)     Blank box in three rows, for the crossing angles and which radius is smaller where, for the area as a sum of polar integrals, and for the symmetry between the two pieces.     "
},
{
...
},
{
  ...
  "body": " Triple Integrals in Rectangular Coordinates  Previously, we learned how to calculate double integrals and how to use them to calculate volumes. Today, we will learn triple integrals in Cartesian coordinates, which can also be used to evaluate volumes of solids, along with other applications that we will learn.    What Does a Triple Integral Mean?  An important application comes first: the mass of a block with variable density (mass per unit volume) is   More generally, a triple integral has the form , defined by chopping the solid into tiny blocks of volume , sampling in each block, and passing to the limit. A natural question is: what does mean? We can think of it as summing the volumes of the tiny blocks , hence      Case I:    The first case that we will study is the case where the region of integration is of the form   so lies between the surfaces and over a projection in the -plane, and    Example I   Calculate the triple integral , where is the tetrahedron shown in , bounded by the coordinate planes and the plane .   Solution. (Begin by describing the projection of the tetrahedron into the -plane; sketch it on . Then describe in the form of Case I, with running from the floor to the plane, and evaluate the iterated integral from the inside out.)     Blank box in three rows, for the description of the projection, for the description of the solid, and for the iterated integral and its evaluation.       The tetrahedron of , bounded by the three coordinate planes and the plane . Its projection into the -plane is the triangle .   A tetrahedron cut from the first octant by a slanted plane, with its shadow triangle shaded.  Three coordinate axes in space with a tetrahedron whose vertices are the origin and the three points one zero zero, zero one zero, and zero zero one. The slanted face is the plane z equals one minus x minus y. The base triangle D in the x y plane is shaded.      Sketch the projection of the tetrahedron into the -plane. At a fixed in , the inner -integration runs up a vertical arrow from the floor to the plane.    Empty coordinate grid, marked at one half and one on each axis, for sketching the projection of the tetrahedron.    The role of the projection and of the inner -integration a column rising from through the solid is animated in .   Animation of iterated triple integration for . The solid is projected onto the triangle in the -plane; at each point of a column runs from up to the surface (the inner integral), and the column then sweeps across (the two outer integrals).       Case II:    The second case is entirely similar to , but the projection is described with horizontal strips:   and the corresponding iterated integral is . In fact, by projecting into the - or -plane instead, a triple integral can be set up in six different orders of integration; the next example illustrates three of them.   Example II   Set up the triple integrals below whose value gives the volume of the region of , bounded by the cylinder , the plane , and the coordinate planes. Then, evaluate two out of the three integrals.          Question: How many more triple integrals can you think of for computing such a volume? (Three more; six in total.)   Solution. (For each order, the two outer variables describe a projection of into a coordinate plane, and the 3D figure gives the limits of the innermost variable. Sketch the three projections on . In A , project into the -plane. In B , project into the -plane; solve the cylinder for . In C , project into the -plane: which surface does a ray in the -direction reach first, the plane or the cylinder? The answer depends on where is, so the projection splits along a curve, and two integrals are needed. Evaluate two of the three, and check that they agree.)     Blank box in three labelled rows, one for each order of integration, with room to set up and evaluate the iterated integrals.       The solid of , bounded by the parabolic cylinder , the vertical plane , and the coordinate planes.   A solid under a parabolic cylinder, cut by a slanted vertical plane.  Three coordinate axes in space with a solid bounded above by the parabolic cylinder z equals one minus x squared, on the side by the vertical plane y equals one minus x, and by the coordinate planes. The curved top descends from height one at the z axis to zero at x equals one.      Sketch the three projections of the solid . Left: into the -plane (order ). Middle: into the -plane (order ). Right: into the -plane (order ); mark the curve that splits it into and .     Empty x y grid for sketching the projection of the solid into the x y plane.     Empty x z grid for sketching the projection of the solid into the x z plane.     Empty y z grid for sketching the projection of the solid into the y z plane and the curve that splits it.      The solid itself, to turn around: the triangular base in the -plane, the surface that caps it, and the two edges of that cap above and above . The vertical plane slices the solid the way the innermost integral does.       Mass With Variable Density   Example III   Assume that the density (mass per unit volume) is given by . Evaluate the mass of the solid of .   Solution. (Use the mass formula with the same limits as in Part A of .)     Blank box for setting up and evaluating the mass integral.        Concept Check  The first five questions all concern the same solid , the region bounded below by the paraboloid and above by the upper half of the sphere of radius centered at , drawn in . Four of them ask for a sign or a yes-or-no answer rather than a number: the point is to read the integrand on the region, not to integrate.  It is worth locating first. Find where the two surfaces meet (set the two expressions for equal and write ), and describe : over which region of the -plane does it sit, and between which surfaces does run?     Blank box in two rows, one for finding where the paraboloid and the sphere meet and one for the description of the solid.     The sign of an integral, without calculating    Without calculation , decide whether the integral below is positive, negative, or zero. The region of integration is the region bounded by and . See .    Positive  Negative  Zero    Hint : begin by determining the limits of integration.  (Compare the integrand with the upper surface of : what sign does it have at every point of the solid, and where does it vanish?)     Blank box for the sign of the integral and its justification.       Could it be a mass density?   Can the function represent mass density (mass per unit volume) over the region , which is graphed in ?   Yes  No   (What sign must a mass density have?)     Blank box for the answer and its justification.       Could it be a charge density?   Can the function represent charge density (charge per unit volume) over the region , which is graphed in ?   Yes  No   (What is different about charge? What would the integral of then mean?)     Blank box for the answer and its justification.       The sign of a second integral    Without calculation , decide whether the integral below is positive, negative, or zero. The region of integration is the region bounded by and . See .    Positive  Negative  Zero   (Over which disk does sit? Use that to bound , and so the integrand, on all of .)     Blank box for the sign of the integral and its justification.       Could this one be a mass density?   Can the function represent mass density (mass per unit volume) over the region , which is graphed in ?   Yes  No   (Bound on . Would the same formula do on a larger region?)     Blank box for the answer and its justification.       Figure (3): the region of integration , bounded below by the paraboloid and above by . The two surfaces meet over the circle .     A volume between two cylinders   Set up a triple integral for computing the volume of the region bounded by the two cylinders and and the two planes and . See .  (The two cylinders are vertical walls standing on two curves of the -plane; where do the curves cross, and which is on top in between? That gives the shadow . The floor and the ceiling give the limits of . Set up the integral, and note what the innermost integration returns.)     Blank box in two rows, one for the shadow of the solid and one for the triple integral with limits.       Figure (4): the solid bounded by the cylinders and , the plane , and the plane , whose two edges are drawn on the walls.     "
},
{
...
},
{
  ...
  "number": "2.5.1",
  "title": "Example I.",
  "body": " Example I   Calculate the triple integral , where is the tetrahedron shown in , bounded by the coordinate planes and the plane .   Solution. (Begin by describing the projection of the tetrahedron into the -plane; sketch it on . Then describe in the form of Case I, with running from the floor to the plane, and evaluate the iterated integral from the inside out.)     Blank box in three rows, for the description of the projection, for the description of the solid, and for the iterated integral and its evaluation.     "
},
{
...
},
{
  ...
  "number": "2.5.3",
  "title": "",
  "body": " Sketch the projection of the tetrahedron into the -plane. At a fixed in , the inner -integration runs up a vertical arrow from the floor to the plane.    Empty coordinate grid, marked at one half and one on each axis, for sketching the projection of the tetrahedron.   "
},
{
...
},
{
  ...
  "number": "2.5.5",
  "title": "Example II.",
  "body": " Example II   Set up the triple integrals below whose value gives the volume of the region of , bounded by the cylinder , the plane , and the coordinate planes. Then, evaluate two out of the three integrals.          Question: How many more triple integrals can you think of for computing such a volume? (Three more; six in total.)   Solution. (For each order, the two outer variables describe a projection of into a coordinate plane, and the 3D figure gives the limits of the innermost variable. Sketch the three projections on . In A , project into the -plane. In B , project into the -plane; solve the cylinder for . In C , project into the -plane: which surface does a ray in the -direction reach first, the plane or the cylinder? The answer depends on where is, so the projection splits along a curve, and two integrals are needed. Evaluate two of the three, and check that they agree.)     Blank box in three labelled rows, one for each order of integration, with room to set up and evaluate the iterated integrals.     "
},
{
...
},
{
  ...
  "number": "2.5.7",
  "title": "",
  "body": " Sketch the three projections of the solid . Left: into the -plane (order ). Middle: into the -plane (order ). Right: into the -plane (order ); mark the curve that splits it into and .     Empty x y grid for sketching the projection of the solid into the x y plane.     Empty x z grid for sketching the projection of the solid into the x z plane.     Empty y z grid for sketching the projection of the solid into the y z plane and the curve that splits it.    "
},
{
...
},
{
  ...
  "number": "2.5.9",
  "title": "Example III.",
  "body": " Example III   Assume that the density (mass per unit volume) is given by . Evaluate the mass of the solid of .   Solution. (Use the mass formula with the same limits as in Part A of .)     Blank box for setting up and evaluating the mass integral.     "
},
{
  ...
  "body": " The sign of an integral, without calculating    Without calculation , decide whether the integral below is positive, negative, or zero. The region of integration is the region bounded by and . See .    Positive  Negative  Zero    Hint : begin by determining the limits of integration.  (Compare the integrand with the upper surface of : what sign does it have at every point of the solid, and where does it vanish?)     Blank box for the sign of the integral and its justification.     "
},
{
  ...
  "body": " Could it be a mass density?   Can the function represent mass density (mass per unit volume) over the region , which is graphed in ?   Yes  No   (What sign must a mass density have?)     Blank box for the answer and its justification.     "
},
{
  ...
  "body": " Could it be a charge density?   Can the function represent charge density (charge per unit volume) over the region , which is graphed in ?   Yes  No   (What is different about charge? What would the integral of then mean?)     Blank box for the answer and its justification.     "
},
{
  ...
  "body": " The sign of a second integral    Without calculation , decide whether the integral below is positive, negative, or zero. The region of integration is the region bounded by and . See .    Positive  Negative  Zero   (Over which disk does sit? Use that to bound , and so the integrand, on all of .)     Blank box for the sign of the integral and its justification.     "
},
{
  ...
  "body": " Could this one be a mass density?   Can the function represent mass density (mass per unit volume) over the region , which is graphed in ?   Yes  No   (Bound on . Would the same formula do on a larger region?)     Blank box for the answer and its justification.     "
},
{
...
},
{
  ...
  "body": " A volume between two cylinders   Set up a triple integral for computing the volume of the region bounded by the two cylinders and and the two planes and . See .  (The two cylinders are vertical walls standing on two curves of the -plane; where do the curves cross, and which is on top in between? That gives the shadow . The floor and the ceiling give the limits of . Set up the integral, and note what the innermost integration returns.)     Blank box in two rows, one for the shadow of the solid and one for the triple integral with limits.     "
},
{
...
},
{
  ...
  "body": " Triple Integrals in Cylindrical Coordinates  Previously, we learned how to calculate triple integrals in rectangular coordinates. Today, we will learn triple integrals in cylindrical coordinates, which can be used to evaluate volumes of solids or to integrate a function over a region in space. We will see that when there is symmetry about an axis, it is more convenient to use cylindrical coordinates to calculate a triple integral.    Cylindrical Coordinates  Cylindrical coordinates are the combination of polar coordinates in the -plane and the -coordinate of Cartesian coordinates; see . Thus, adding to , the relations between Cartesian and cylindrical coordinates are     A point in cylindrical coordinates: are the polar coordinates of its projection into the -plane, and is its usual height.   A point in space located by a radius in the plane, an angle, and a height.  Three coordinate axes in space. A point P is shown above the x y plane. A segment of length r runs from the origin to the projection of P in the x y plane, making an angle theta with the positive x axis, and a vertical segment of length z connects the projection to P.     Before calculating triple integrals in cylindrical coordinates, we need to figure out the volume element in this new set of coordinates. Remember from that the area element in polar coordinates is . Stack it through a height , and write down the cylindrical volume element. (The applet below builds the element one edge at a time; check your answer against the three edge lengths.)     Blank box with one row, for the cylindrical volume element.     The Cylindrical Volume Element       Now suppose our goal is to integrate over a region described as   where the region is known in polar coordinates:   Then the iterated integral , written as , can be converted to cylindrical coordinates:      The Mass of a Solid With Axial Symmetry   Example I   A solid lies within the cylinder , below the plane , and above the paraboloid . Given that the density of the solid at any point is proportional to its distance from the axis of the cylinder, find the mass of the solid.   Solution. (Begin by plotting the region, shown in . Write the cylinder and the paraboloid in cylindrical coordinates, and describe with running from the paraboloid up to the plane. Turn the description of the density into a formula distance from the axis is a familiar quantity in these coordinates. Then compute the mass by and , and compare with .)     Blank box in four rows, for the cylindrical equations of the bounding surfaces, for the description of the solid, for the density in cylindrical coordinates, and for the mass integral and its evaluation.       The solid of : inside the cylinder , above the paraboloid , and below the plane .   A vertical cylinder with a flat top and a dome-shaped paraboloid floor.  Three coordinate axes in space with a vertical circular cylinder of radius one about the z axis, capped by the plane z equals four on top. Inside the bottom of the cylinder, the paraboloid z equals one minus r squared forms a dome shaped floor that touches the point zero zero one on the z axis and meets the cylinder wall at the x y plane.     The way a column of the solid runs from the paraboloid floor up to the plane , and how it sweeps around the axis, is animated in .   Animation of the cylindrical setup for . A column at runs from the paraboloid floor up to the plane , and sweeps through the solid as goes around the axis, illustrating .      Concept Check  Each part below describes a solid by the surfaces that bound it. Set up a triple integral in cylindrical coordinates that gives its volume: the work is all in the limits, and supplies the rest. Try each part from the description alone the solution shows the solid, so you can check whether the picture in your head was the right one.   Eight volumes in cylindrical coordinates   Set up triple integrals, in cylindrical coordinates, which give the volume of each of the following regions.     The volume of the region bounded above by the paraboloid , below by the plane , and on the side by the cylinder .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (a).        The volume of the region bounded below by the paraboloid and above by the plane .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (b).        The volume of the region bounded above by the paraboloid , below by the plane , and on the side by the cylinder .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (c).        The volume of the region bounded below by the lower half of the sphere and above by the plane .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (d).        The volume of the region bounded by the cone and the planes and .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (e).        The volume of the region bounded by the hyperboloid of one sheet and the planes and .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (f).        The volume of the region bounded by the cone and the planes and .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (g).        The volume of the region bounded above by the cone , below by the plane , and on the side by the cylinder .     Blank box in two rows, one for the bounding surfaces in cylindrical coordinates and one for the triple integral with its limits.      The solid is shown below. Compare it with the picture you formed from the description before setting up the integral.   The solid of part (h).        "
},
{
...
},
{
  ...
  "number": "2.6.2",
  "title": "Example I.",
  "body": " Example I   A solid lies within the cylinder , below the plane , and above the paraboloid . Given that the density of the solid at any point is proportional to its distance from the axis of the cylinder, find the mass of the solid.   Solution. (Begin by plotting the region, shown in . Write the cylinder and the paraboloid in cylindrical coordinates, and describe with running from the paraboloid up to the plane. Turn the description of the density into a formula distance from the axis is a familiar quantity in these coordinates. Then compute the mass by and , and compare with .)     Blank box in four rows, for the cylindrical equations of the bounding surfaces, for the description of the solid, for the density in cylindrical coordinates, and for the mass integral and its evaluation.     "
},
{
...
},
{
  ...
  "number": "2.6.4",
  "title": "",
  "body": " Animation of the cylindrical setup for . A column at runs from the paraboloid floor up to the plane , and sweeps through the solid as goes around the axis, illustrating .   "
},
{
...
},
{
  ...
  "body": " Triple Integrals in Spherical Coordinates  Today, we will study yet another useful coordinate system in three dimensions, which is known as the spherical coordinate system . It simplifies the evaluation of triple integrals over regions bounded by spheres or cones.    Spherical Coordinates  The spherical coordinates can be best explained in a figure. Consider the point with spherical coordinates shown in .      is the distance of the point from the origin ( ).     is the angle the projection of makes with the positive -axis. This is the same as in cylindrical coordinates, ( ).     is the angle between and the positive -axis ( ).      A point in spherical coordinates: is the distance from the origin, is the usual polar angle of the projection into the -plane, and is the angle between and the positive -axis.   A point in space located by a distance from the origin and two angles.  Three coordinate axes in space. A segment of length rho runs from the origin to a point P above the x y plane. The angle phi is marked between the positive z axis and the segment, and the angle theta is marked in the x y plane between the positive x axis and the dashed projection of the segment. A dashed vertical line connects P to its projection.      Equations Relating Spherical Coordinates to Cartesian and Cylindrical Coordinates      Spheres and cones have particularly simple equations in spherical coordinates. Substitute into the equation of a sphere of radius centered at the origin, , and simplify.     Blank box for converting the equation of a sphere centered at the origin to spherical coordinates.     Example I   Find the equation of the sphere in spherical coordinates.   Solution. (Substitute , expand the square, and use ; a factor of cancels.)     Blank box for converting the equation of the shifted sphere to spherical coordinates.       Example II   What are the equations of the two cones and in spherical coordinates?   Solution. (What angle does each cone make with the positive -axis? Confirm algebraically by substituting .)     Blank box for the spherical equations of the two cones.       Coordinate Conversion Formulas   The corresponding formulas for in triple integrals (see and ):       Integration in Spherical Coordinates  The volume element in spherical coordinates is illustrated in : a spherical wedge with radial side , one arc side , and the other arc side . Say where each of the three edge lengths comes from, and multiply them to get .     Blank box in two rows, one for the three edge lengths of the spherical wedge and one for the volume element.     The Spherical Volume Element       The spherical volume element (spherical wedge), with sliders for the three increments. Its three mutually perpendicular sides have lengths , , and .    Then, the triple integral over a region described in spherical coordinates by , , and can be converted into spherical coordinates as follows:      The Ice Cream Cone   Example III   Find the volume of the ice cream cone  cut from the solid sphere by the cone .   Solution. (Plot the ice cream cone, shown in , and describe it by the ranges of , and . Then use and with , and compare with .)     Blank box in two rows, one for the spherical description of the ice cream cone and one for the volume integral and its evaluation.       The ice cream cone of : the region inside the sphere and above the cone .   An ice cream cone shape: a cone from the origin capped by a piece of a sphere.  Three coordinate axes in space with an ice cream cone shaped solid: a cone with vertex at the origin opening upward at sixty degrees from the z axis, capped by a dome which is part of the unit sphere. The circle where the cone meets the sphere is drawn.     How the spherical description of the ice cream cone works the angle sweeping from the -axis down to the cone while reaches out to the sphere is animated in .   Animation of spherical coordinates and the ice cream cone. A ray from the origin at angles carries the point ; sweeping spins the ray around the -axis, sweeping tilts it away from the axis, and restricting , fills out the ice cream cone of .       Converting a Triple Integral to Spherical Coordinates   Example IV   Calculate the triple integral below by converting it to spherical coordinates:    Solution. (Read the solid off the limits: the -limits are the two halves of a sphere; which one, and where is its center? It is shown in . Convert its equation to spherical coordinates as in , and describe the solid by the ranges of , and ; the integrand is a power of . Then apply ; the -integral is a substitution.)     Blank box in four rows, for identifying the solid and its spherical equation, for the limits and the integrand, for the spherical iterated integral, and for its evaluation.       The sphere of . It sits on the -plane, touching the origin.   A sphere resting on the origin, centered on the vertical axis.  Three coordinate axes in space with a sphere of radius two centered on the z axis at height two, so it touches the origin from above. A dashed vertical diameter runs from the origin to the north pole at height four.        Re-Writing an Integral in Spherical and Cylindrical Coordinates   Example V   Re-write (do not evaluate) the following integral in spherical and cylindrical coordinates:    Solution. (Read the -projection off the outer two limits, shown in , and describe it in polar coordinates. The -limits run from a cone up to a plane; the solid is shown in . For the cylindrical form, convert the cone and the integrand and use . For the spherical form, the cone is a fixed , and the plane becomes an upper limit on that depends on ; convert the integrand and use .)     Blank box in three rows, for the projection and the bounding surfaces in the new coordinates, for the cylindrical form of the integral, and for the spherical form.       The -projection of the solid in : the lower half of the unit disk.   The lower half of the unit disk, shaded.    arc(t) = (cos(t), sin(t))       y = -\\sqrt{1-x^2}   1    -1               The solid of : over the lower half disk, between the cone and the plane .   A half cone over the negative y half plane, capped by a flat half disk.  Three coordinate axes in space with a half cone opening upward from the origin at forty five degrees, over the half of the plane with y negative, capped above by the flat half disk in the plane z equals one. The straight edge of the cap lies over the x axis.       Calculate the volume of the region inside and below .     Blank box in two rows, one for the spherical description of the region and one for the volume integral and its evaluation.       "
},
{
...
},
{
  ...
  "number": "2.7.2",
  "title": "Example I.",
  "body": " Example I   Find the equation of the sphere in spherical coordinates.   Solution. (Substitute , expand the square, and use ; a factor of cancels.)     Blank box for converting the equation of the shifted sphere to spherical coordinates.     "
},
{
  ...
  "number": "2.7.3",
  "title": "Example II.",
  "body": " Example II   What are the equations of the two cones and in spherical coordinates?   Solution. (What angle does each cone make with the positive -axis? Confirm algebraically by substituting .)     Blank box for the spherical equations of the two cones.     "
},
{
  ...
  "number": "2.7.4",
  "title": "",
  "body": " The spherical volume element (spherical wedge), with sliders for the three increments. Its three mutually perpendicular sides have lengths , , and .   "
},
{
  ...
  "number": "2.7.5",
  "title": "Example III.",
  "body": " Example III   Find the volume of the ice cream cone  cut from the solid sphere by the cone .   Solution. (Plot the ice cream cone, shown in , and describe it by the ranges of , and . Then use and with , and compare with .)     Blank box in two rows, one for the spherical description of the ice cream cone and one for the volume integral and its evaluation.     "
},
{
  ...
  "number": "2.7.6",
  "title": "",
  "body": " The ice cream cone of : the region inside the sphere and above the cone .   An ice cream cone shape: a cone from the origin capped by a piece of a sphere.  Three coordinate axes in space with an ice cream cone shaped solid: a cone with vertex at the origin opening upward at sixty degrees from the z axis, capped by a dome which is part of the unit sphere. The circle where the cone meets the sphere is drawn.    "
},
{
...
},
{
  ...
  "number": "2.7.8",
  "title": "Example IV.",
  "body": " Example IV   Calculate the triple integral below by converting it to spherical coordinates:    Solution. (Read the solid off the limits: the -limits are the two halves of a sphere; which one, and where is its center? It is shown in . Convert its equation to spherical coordinates as in , and describe the solid by the ranges of , and ; the integrand is a power of . Then apply ; the -integral is a substitution.)     Blank box in four rows, for identifying the solid and its spherical equation, for the limits and the integrand, for the spherical iterated integral, and for its evaluation.     "
},
{
  ...
  "number": "2.7.9",
  "title": "",
  "body": " The sphere of . It sits on the -plane, touching the origin.   A sphere resting on the origin, centered on the vertical axis.  Three coordinate axes in space with a sphere of radius two centered on the z axis at height two, so it touches the origin from above. A dashed vertical diameter runs from the origin to the north pole at height four.    "
},
{
  ...
  "number": "2.7.10",
  "title": "Example V.",
  "body": " Example V   Re-write (do not evaluate) the following integral in spherical and cylindrical coordinates:    Solution. (Read the -projection off the outer two limits, shown in , and describe it in polar coordinates. The -limits run from a cone up to a plane; the solid is shown in . For the cylindrical form, convert the cone and the integrand and use . For the spherical form, the cone is a fixed , and the plane becomes an upper limit on that depends on ; convert the integrand and use .)     Blank box in three rows, for the projection and the bounding surfaces in the new coordinates, for the cylindrical form of the integral, and for the spherical form.     "
},
{
  ...
  "number": "2.7.11",
  "title": "",
  "body": " The -projection of the solid in : the lower half of the unit disk.   The lower half of the unit disk, shaded.    arc(t) = (cos(t), sin(t))       y = -\\sqrt{1-x^2}   1    -1             "
},
{
...
},
{
  ...
  "number": "2.7.13",
  "title": "",
  "body": "  Calculate the volume of the region inside and below .     Blank box in two rows, one for the spherical description of the region and one for the volume integral and its evaluation.     "
},
{
  ...
  "body": " Applications: Mass and Center of Mass   Multiple integrals let us compute physical quantities of solid objects and flat plates whose density varies from point to point. In this section we use double and triple integrals to compute the total mass of an object and to locate its center of mass the point at which the object would balance perfectly.     Finding the Center of Mass of a 3D Object  Suppose a solid object occupies a region in space and its density (mass per unit volume) at each point is given by a continuous function . To measure the total mass, we partition into small boxes, as in . If the -th box contains the point and has volume , write down its approximate mass, sum over the boxes, and let the size of the boxes shrink to zero.     Blank box in two rows, one for the mass of a small box and one for the total mass as a limit of Riemann sums and as a triple integral.     Mass of a Solid      Watch the construction unfold in .   Partitioning a solid into small boxes: each box carries the mass , and the Riemann sum of these masses converges to the triple integral of the density.     A solid region with a small box around the point . The box has volume and mass .   A potato-shaped solid in space with a small highlighted box inside it.   A translucent potato-shaped solid labeled floats above the -plane in a three-dimensional coordinate system. A small purple box inside the solid marks the point , and a leader line labels its mass .      The same idea locates the balance point of the object. Each small box contributes a moment about each coordinate plane its mass times its (signed) distance from that plane. Adding these contributions and passing to the limit gives the first moments    The center of mass  is the point whose coordinates are the moments divided by the total mass:    Center of Mass of a Solid Bounded by a Paraboloid   Find the center of mass of a solid of constant density , which is bounded by the disk (in the plane ) and the paraboloid .   Solution. (The solid is shown in . Use its symmetry to dispose of two of the three coordinates at once. For the third, work in cylindrical coordinates with : describe the region, compute by and the needed moment by , and divide as in . What happens to ? Compare with .)     Blank box in five rows, for the symmetry argument, for the cylindrical description of the region, for the mass, for the first moment about the x y plane, and for the center of mass.       The solid bounded above by and below by the disk . By symmetry the center of mass lies on the -axis; use the animation to check its height.     The solid of constant density bounded by the paraboloid and the disk : in the plane . The center of mass sits on the axis of symmetry.   A dome-shaped solid over a disk with its center of mass marked on the vertical axis.   The paraboloid forms a translucent green dome over the disk in the -plane, labeled . The dashed -axis passes through the apex at height 4, and a magenta dot on the axis at height marks the center of mass.         Centroids    When the density of a solid object (as in the previous example) or plate (as in the next example) is constant, the center of mass is called the centroid of the object.    As we saw in , a constant density cancels in the quotients of , so the centroid depends only on the shape of the object. For a flat plate occupying a region in the plane with density (mass per unit area), the same reasoning that gave and with double integrals in place of triple integrals gives the mass and first moments   where is the moment about the -axis and the moment about the -axis, and the center of mass is    Centroid of the Region Between Two Curves   Find the centroid of the region between and .   Solution. (Find where the curves meet, and describe the region, shown in . Since only the centroid is wanted, what may you take to be, and what does then measure? Compute , and from , divide as in , and explain from the picture why had to happen. Compare with .)     Blank box in five rows, for the description of the region, for the mass, for the two first moments, and for the centroid with the symmetry explanation.       The region between and is symmetric about the line , and its centroid lies on that line. Use the animation to check its coordinates.     The region between (blue) and (red) over , with its centroid marked.   The region between the square-root curve and the parabola, from 0 to 1.    f(x) = sqrt(x)  g(x) = x^2         (1,1)     \\left(\\frac{9}{20},\\frac{9}{20}\\right)    y=\\sqrt{x}    y=x^2                  Centroid of a Cardioid   Find the centroid of the object that has the shape and density .   Solution. (The cardioid is shown in . Use its symmetry to dispose of one coordinate. Work in polar coordinates with from and : compute and from . In the -integrals, the odd powers of cosine integrate to zero over a full period, , and . Then divide as in ; what happens to ? Compare with .)     Blank box in four rows, for the symmetry argument, for the mass in polar coordinates, for the moment about the y axis, and for the centroid.       The cardioid with constant density: symmetry places the centroid on the -axis, and the polar moment integrals locate it. Use the animation to check your value.     The cardioid . The region is symmetric about the -axis and its centroid is marked in maroon.   A cardioid symmetric about the x axis with shaded interior.    c(t) = ((1 + cos(t))*cos(t), (1 + cos(t))*sin(t))      \\left(\\frac{5}{6},0\\right)    r=1+\\cos(\\theta)               "
},
{
...
{
  "id": "sec-mass-3d-object-8",
  "level": "2",
  "url": "section-mass-center-of-mass.html#sec-mass-3d-object-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "sec-mass-3d-object-10",
  "level": "2",
  "url": "section-mass-center-of-mass.html#sec-mass-3d-object-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "center of mass "
},
{
  ...
  "body": " Center of Mass of a Solid Bounded by a Paraboloid   Find the center of mass of a solid of constant density , which is bounded by the disk (in the plane ) and the paraboloid .   Solution. (The solid is shown in . Use its symmetry to dispose of two of the three coordinates at once. For the third, work in cylindrical coordinates with : describe the region, compute by and the needed moment by , and divide as in . What happens to ? Compare with .)     Blank box in five rows, for the symmetry argument, for the cylindrical description of the region, for the mass, for the first moment about the x y plane, and for the center of mass.     "
},
{
  ...
  "number": "2.8.4",
  "title": "",
  "body": " The solid bounded above by and below by the disk . By symmetry the center of mass lies on the -axis; use the animation to check its height.   "
},
{
...
},
{
  ...
  "body": " Centroid of the Region Between Two Curves   Find the centroid of the region between and .   Solution. (Find where the curves meet, and describe the region, shown in . Since only the centroid is wanted, what may you take to be, and what does then measure? Compute , and from , divide as in , and explain from the picture why had to happen. Compare with .)     Blank box in five rows, for the description of the region, for the mass, for the two first moments, and for the centroid with the symmetry explanation.     "
},
{
  ...
  "number": "2.8.8",
  "title": "",
  "body": " The region between and is symmetric about the line , and its centroid lies on that line. Use the animation to check its coordinates.   "
},
{
  ...
  "number": "2.8.9",
  "title": "",
  "body": " The region between (blue) and (red) over , with its centroid marked.   The region between the square-root curve and the parabola, from 0 to 1.    f(x) = sqrt(x)  g(x) = x^2         (1,1)     \\left(\\frac{9}{20},\\frac{9}{20}\\right)    y=\\sqrt{x}    y=x^2                "
},
{
  ...
  "body": " Centroid of a Cardioid   Find the centroid of the object that has the shape and density .   Solution. (The cardioid is shown in . Use its symmetry to dispose of one coordinate. Work in polar coordinates with from and : compute and from . In the -integrals, the odd powers of cosine integrate to zero over a full period, , and . Then divide as in ; what happens to ? Compare with .)     Blank box in four rows, for the symmetry argument, for the mass in polar coordinates, for the moment about the y axis, and for the centroid.     "
},
{
  ...
  "number": "2.8.11",
  "title": "",
  "body": " The cardioid with constant density: symmetry places the centroid on the -axis, and the polar moment integrals locate it. Use the animation to check your value.   "
},
{
...
},
{
  ...
  "body": " Substitution in Multiple Integrals and the Jacobian Determinant   In single-variable calculus, substitution converts a difficult integral into an easier one at the cost of a correction factor . In this section we develop the analogous tool for double and triple integrals. The correction factor is now a determinant the Jacobian determinant which measures how a change of variables stretches or shrinks area and volume.     The Jacobian Determinant  Assume that there exists a transformation that relates two coordinate systems, and coordinates. In other words, there exist two functions and such that and . As illustrated in , the region in the -plane is transformed to the region in the -plane, and the inverse transformation carries back to .   The transformation carries the region in the -plane onto the region in the -plane; the inverse carries back onto . The point is sent to the point .    A blob-shaped region S in the u v plane with a marked point.    blobS(t) = (1.55 + (1 + 0.22*sin(2*t))*cos(t), 1.7 + (0.78 + 0.1*cos(3*t))*sin(t))      (u_1,v_1)    S              A blob-shaped region R in the x y plane with a marked point.    blobR(t) = (1.75 + (1.05 + 0.18*cos(2*t))*cos(t), 1.6 + (0.72 + 0.14*sin(3*t))*sin(t))      (x_1,y_1)    R                 The Jacobian determinant of the transformation , is defined as   In 3D, this definition is generalized to     Then the multiple integrals can be converted from one coordinate system to another as follows:   and in three dimensions, with , , carrying a region in -space onto a region in -space,   The integrals and should be compared to the single-variable substitution :   Note that in the past we used to use the substitution of the form and write:   The derivative factor records how much the substitution stretches lengths. In two variables, the Jacobian determinant plays the same role for areas: is the local ratio of area in the -plane to area in the -plane. The next example makes this ratio concrete.   A First Substitution: Scaling a Rectangle   Use the transformation , to evaluate   and verify that the Jacobian determinant equals the ratio of the areas of the two regions of integration.   Solution. (Solve for and to get , and find the region in the -plane that carries onto the unit square; both are shown in . Compute the Jacobian by and compare it with the ratio of the two areas. Then substitute, using , and check against a direct evaluation of the original integral. Compare with .)     Blank box in four rows, for the transformation and the region S, for the Jacobian and the area ratio, for the substituted integral, and for the direct check.       The transformation maps a rectangle onto the unit square . Watch how the Jacobian acts as the ratio of the areas.     The rectangle in the -plane (right) and its image, the unit square , in the -plane (left) under .    The unit square R in the x y plane.        R             The rectangle S from the origin to (3,2) in the u v plane.        S                 Choosing a Transformation  In practice we usually run the process in the other direction: the region of integration is awkward in -coordinates, and we look for a substitution under which it corresponds to a simple region ideally a rectangle with constant limits of integration. The boundary curves of usually tell us what and should be.   A Parallelogram Region   Use the transformation to compute   where is the parallelogram bounded by the lines , , , and , shown in .   Solution. (Read and off and compute the Jacobian by . Invert the transformation to get and in terms of and , and translate each of the four boundary lines; the parallelogram should become a rectangle, shown in . Rewrite the integrand in and , apply , and evaluate. Compare with .)     Blank box in four rows, for the transformation and its Jacobian, for the inverse and the rectangle, for the integrand in the new variables, and for the substituted integral and its evaluation.       The substitution straightens the parallelogram into a rectangle. Watch what happens to areas, and compare with the Jacobian you computed.     The parallelogram between the lines , , , and (left), and the corresponding rectangle in the -plane (right).    A parallelogram between two slanted lines and two horizontal lines.    l1(x) = (6 - x)\/2  l2(x) = (10 - x)\/2          x+2y=10    x+2y=6    D               The rectangle R in the u v plane, image of the parallelogram.        R               A Curved Region Mapped to a Rectangle   Let be the region in the first quadrant bounded by the hyperbolas , , , and , shown in .     Find a transformation that relates to a rectangle .    Compute the integral .      Solution. (In A , let the boundary curves suggest and : each pair of curves should become a pair of lines or . Describe the rectangle ; compare with . In B , the substitution is given in the direction , , so first compute ; by the inverse function theorem the Jacobian you need, , is its reciprocal. Then apply : a factor in the integrand cancels against the Jacobian, and what is left is a function of alone. Compare with .)     Blank box in four rows, for the substitution and the rectangle, for the Jacobian in the easy direction and its reciprocal, for the substituted integral, and for its evaluation.       The substitution maps the region between the four hyperbolas onto a rectangle. Watch what the Jacobian does to the integrand.     The region bounded by the hyperbolas and , (left) corresponds to a rectangle in the -plane (right).    A curved region bounded by two families of hyperbolas in the first quadrant.    hyp(x,y) = x^2 - y^2  prod(x,y) = x*y          x^2-y^2=-3    x^2-y^2=3    xy=4    xy=1    D                 The rectangle R in the u v plane, image of the curved region.        R                 Substitution in Triple Integrals   Volume of a Parallelepiped by Substitution   Find the volume of the parallelepiped shown in by writing the equations of all faces of the parallelepiped and describing it by three inequalities. Use a suitable change of variables such that all the integral limits are constants (as opposed to functions).   Solution. (Four of the faces are parallel to coordinate planes; write their equations. For the two slanted faces, find a normal vector from two edge directions with a cross product, then use a point on each face to write its equation. Describe the parallelepiped by three inequalities, and choose , , so that each inequality becomes a constant range: that turns the solid into a box . Compute the Jacobian in the easy direction with and take the reciprocal, as in the previous example. Then apply , and compare with .)     Blank box in six rows, for the four easy faces, for the normal and equations of the slanted faces, for the description of the parallelepiped, for the change of variables and the box, for the Jacobian, and for the volume.       Finally, we would like to mention that there is a much easier way of calculating the volume of a parallelepiped (using the so-called box product); however, the method above is a rich example in calculus and definitely worth learning. For example, you may need to integrate a function over the parallelepiped, which cannot be done using the box product.    A change of variables shears the parallelepiped into a box. Compare the box, and the volume, with what you found.     The parallelepiped bounded by the planes , , , , , and .   A long slanted box in space bounded by six planes.   A parallelepiped drawn with crimson edges in a three-dimensional coordinate system. Its base is the unit square in the plane , sheared in the -direction: the bottom face lies between the planes and , and the top face, at height , is shifted one unit in .       Volume of an Ellipsoid   Use the method of substitution in multiple integrals to show that the volume of the ellipsoid   is equal to .   Solution. (The ellipsoid is a stretched sphere: choose a transformation that carries the unit ball onto the solid ellipsoid , as in . Compute the Jacobian by , apply , and use the volume of the unit ball. Compare with .)     Blank box in three rows, for the transformation, for its Jacobian, and for the volume of the ellipsoid by substitution.       Stretching the unit sphere by factors , , and along the coordinate axes produces the ellipsoid; the Jacobian scales the volume from to .     The transformation carries the unit ball onto the solid ellipsoid with semi-axes , , .   A unit sphere on the left is mapped by an arrow labeled T to an ellipsoid on the right.   On the left, the unit sphere , labeled , drawn as a translucent gray-blue ball. An arrow labeled points to the right, where the ellipsoid , labeled , is drawn as a translucent green surface, wider than it is tall, with its three semi-axes , , and drawn in vermillion, blue, and green.         Activity: Watching a Substitution Transform a Region   From a Rectangle to a Curved Region   Use the transformation   to compute   where   Also, make sure to graph the region of integration in the -plane. Note: choose a suitable substitution such that the limits of integration are numbers as opposed to functions.   The interactive below shows exactly this transformation at work: a rectangle in the -plane (left) is carried by onto a curved region in the -plane (right). Drag the rectangle's corner and adjust its dimensions until its image is exactly the region , and use what you see to read off the constant -limits.    Solution. (The transformation is already solved for and , so translate the description of directly: with , turn into a range of , and turn the two -bounds on into a range of . Sketch the resulting rectangle and check it against the interactive. Compute directly, decide its sign on , rewrite the integrand, and apply ; the integral separates.)     Blank box in four rows, for the ranges of u and v, for the Jacobian, for the integrand in the new variables, and for the substituted integral and its evaluation.     Empty u v grid running from zero to five in each direction, for sketching the region of integration in the u v plane.       "
},
{
...
},
{
  ...
  "body": " A First Substitution: Scaling a Rectangle   Use the transformation , to evaluate   and verify that the Jacobian determinant equals the ratio of the areas of the two regions of integration.   Solution. (Solve for and to get , and find the region in the -plane that carries onto the unit square; both are shown in . Compute the Jacobian by and compare it with the ratio of the two areas. Then substitute, using , and check against a direct evaluation of the original integral. Compare with .)     Blank box in four rows, for the transformation and the region S, for the Jacobian and the area ratio, for the substituted integral, and for the direct check.     "
},
{
  ...
  "number": "2.9.4",
  "title": "",
  "body": " The transformation maps a rectangle onto the unit square . Watch how the Jacobian acts as the ratio of the areas.   "
},
{
  ...
  "number": "2.9.5",
  "title": "",
  "body": " The rectangle in the -plane (right) and its image, the unit square , in the -plane (left) under .    The unit square R in the x y plane.        R             The rectangle S from the origin to (3,2) in the u v plane.        S             "
},
{
  ...
  "body": " A Parallelogram Region   Use the transformation to compute   where is the parallelogram bounded by the lines , , , and , shown in .   Solution. (Read and off and compute the Jacobian by . Invert the transformation to get and in terms of and , and translate each of the four boundary lines; the parallelogram should become a rectangle, shown in . Rewrite the integrand in and , apply , and evaluate. Compare with .)     Blank box in four rows, for the transformation and its Jacobian, for the inverse and the rectangle, for the integrand in the new variables, and for the substituted integral and its evaluation.     "
},
{
  ...
  "number": "2.9.7",
  "title": "",
  "body": " The substitution straightens the parallelogram into a rectangle. Watch what happens to areas, and compare with the Jacobian you computed.   "
},
{
...
},
{
  ...
  "body": " A Curved Region Mapped to a Rectangle   Let be the region in the first quadrant bounded by the hyperbolas , , , and , shown in .     Find a transformation that relates to a rectangle .    Compute the integral .      Solution. (In A , let the boundary curves suggest and : each pair of curves should become a pair of lines or . Describe the rectangle ; compare with . In B , the substitution is given in the direction , , so first compute ; by the inverse function theorem the Jacobian you need, , is its reciprocal. Then apply : a factor in the integrand cancels against the Jacobian, and what is left is a function of alone. Compare with .)     Blank box in four rows, for the substitution and the rectangle, for the Jacobian in the easy direction and its reciprocal, for the substituted integral, and for its evaluation.     "
},
{
  ...
  "number": "2.9.10",
  "title": "",
  "body": " The substitution maps the region between the four hyperbolas onto a rectangle. Watch what the Jacobian does to the integrand.   "
},
{
  ...
  "number": "2.9.11",
  "title": "",
  "body": " The region bounded by the hyperbolas and , (left) corresponds to a rectangle in the -plane (right).    A curved region bounded by two families of hyperbolas in the first quadrant.    hyp(x,y) = x^2 - y^2  prod(x,y) = x*y          x^2-y^2=-3    x^2-y^2=3    xy=4    xy=1    D                 The rectangle R in the u v plane, image of the curved region.        R             "
},
{
...
},
{
  ...
  "number": "2.9.14",
  "title": "",
  "body": " A change of variables shears the parallelepiped into a box. Compare the box, and the volume, with what you found.   "
},
{
...
},
{
  ...
  "body": " Volume of an Ellipsoid   Use the method of substitution in multiple integrals to show that the volume of the ellipsoid   is equal to .   Solution. (The ellipsoid is a stretched sphere: choose a transformation that carries the unit ball onto the solid ellipsoid , as in . Compute the Jacobian by , apply , and use the volume of the unit ball. Compare with .)     Blank box in three rows, for the transformation, for its Jacobian, and for the volume of the ellipsoid by substitution.     "
},
{
...
},
{
  ...
  "number": "2.10.1",
  "title": "",
  "body": " A tilted plate of area in a uniform flow . Only the component of along the normal carries fluid through the plate.   A tilted plate in a uniform flow, with its normal vector and the angle between the normal and the velocity marked.   A blue parallelogram-shaped plate stands tilted in a uniform flow of parallel gray velocity arrows pointing up and to the right. A magenta arrow , normal to the plate, makes an angle with the velocity arrows.     "
},
{
  ...
  "number": "2.10.2",
  "title": "",
  "body": " Flow through a flat plate: perpendicular flow, and then the plate tilted by an angle . Use it to check the flow rate you wrote down.   "
},
{
  ...
  "body": " Parametrizing Surfaces   Find parametric representations for each of the following surfaces.                      Solution. (In A , start from the position vector of an arbitrary point and impose the constraint, so that and themselves are the parameters; then do the same in cylindrical and in spherical coordinates, stating the ranges of the parameters. In B , what surface is this, and which coordinate system fits it? In C , one parameter goes around and one is free. Compare with .)     Blank box in three labelled rows, for the parametrizations of the paraboloid in three coordinate systems, of the sphere, and of the cylinder, each with the ranges of its parameters.     "
},
{
...
},
{
  ...
  "body": " Two Orientations of a Cylinder   Consider the cylinder . Describe its two possible orientations.   Solution. (Describe the two normal vectors in words, with reference to the -axis, and say how they are related; see .)     Blank box for describing the two orientations of the cylinder and how they are related.     "
},
{
...
},
{
  ...
  "body": " Flux Across the Unit Sphere   Find the flux of the vector field across the unit sphere .   Solution. (Use the spherical parametrization with its parameter ranges, so that applies; the cross product is , and check that it points outward. Substitute the parametrization into , dot, and integrate over the parameter rectangle; one of the two terms integrates to zero over a full period of . Compare with .)     Blank box in four rows, for the cross product and its orientation, for the field along the sphere, for the integrand, and for the flux integral and its evaluation.     "
},
{
  ...
  "number": "2.10.12",
  "title": "",
  "body": " The field crossing the unit sphere. Use it to check the flux you computed.   "
},
{
  ...
  "body": " Flux Across a Closed Surface   Evaluate the surface integral , where and the surface is the boundary of the solid region enclosed by the paraboloid and the plane .   Solution. (The closed surface has two pieces, shown in : the paraboloid cap and the unit disk in the plane . Which way must the outward normal point on each? Parametrize the cap as a graph, , and compute ; check its -component against the required orientation. Do the same for the disk, fixing the sign if necessary. Then apply to each piece over the unit disk ; on the cap, one term vanishes by symmetry and polar coordinates finish the rest. Compare with .)     Blank box in five rows, for the normal to the cap with its orientation check, for the normal to the disk, for the flux through the cap, for the flux through the disk, and for the total.     "
},
{
  ...
  "number": "2.10.14",
  "title": "",
  "body": " The closed surface made of the paraboloid cap and the disk , with outward normals. Use it to check the flux of through each piece.   "
},
{
...
},
{
  ...
  "body": " Green's Theorem in the Plane   Before we learn about Green's theorem, we will need to learn about two operations on vector fields: curl and divergence . We begin by studying divergence.     Divergence  Consider a vector field to be the velocity field of a fluid. How can we find the net flow rate of the gas through the boundaries of a rectangle shown in ?   The flux of the field through the four sides of a small rectangle with corner , width , and height . Each side's outward component of is drawn in its own color, and the legend gives the dot product it represents.   A rectangle in a vector field with a differently colored outward arrow through each of its four sides, and a legend pairing each color with its dot product.    field(x,y) = (0.4*x + 0.25, 0.32*y + 0.18)      (x,y)    (x+\\Delta x, y)    (x, y+\\Delta y)    (x+\\Delta x, y+\\Delta y)            \\mathbf{F}\\cdot\\mathbf{j}\\gt 0     \\mathbf{F}\\cdot(-\\mathbf{j})\\mathrel{\\unicode{x3C}} 0     \\mathbf{F}\\cdot\\mathbf{i}\\gt 0     \\mathbf{F}\\cdot(-\\mathbf{i})\\mathrel{\\unicode{x3C}} 0    A    \\Delta x    \\Delta y                 Evaluate the flux through each side, assuming the field is nearly constant along each side: on each side take the outward component of times the length of the side, with evaluated at the side's corner shown in the figure. Then add the four contributions, pair the parallel sides, and use the linear approximations and to write the net flow rate.     Blank box in three rows, for the flux through each of the four sides, for the sums over the two pairs of parallel sides, and for the net flow rate out of the rectangle.    Note that this is an approximation, since we are assuming the velocity field has a constant value along each side of the rectangle. The flux density can be calculated as follows:   Note that, in the limit that and approach , represents to what extent a gas is expanding or compressing at each point. This quantity is known as the divergence , and it is denoted by . Watch the construction in .    The divergence of the vector field is defined as   where .     The net flux of out of a small rectangle, divided by its area, converges to the divergence as the rectangle shrinks.     Computing and Interpreting Divergence   The vector fields below represent the velocity field of a gas. Calculate the divergence in each case and explain what it means physically.                 Solution. (Apply to each field, and say what the sign of the result means for the gas at every point. The two fields are drawn in ; does the picture agree?)     Blank box in two labelled rows, one for the divergence of each field with its physical meaning.       Left: the field , which flows away from the origin. Right: the field , which circulates around the origin. Compare with the divergences you computed.    A radial field with arrows pointing away from the origin.    fieldA(x,y) = (2*x, 2*y)               A rotational field circulating counterclockwise around the origin.    fieldB(x,y) = (-y\/(x^2 + y^2 + 0.2), x\/(x^2 + y^2 + 0.2))                   Curl  Again, let us consider a vector field to be the velocity field of a fluid. This time we are interested in answering this question: how can we figure out the circulation density of the fluid at any point on the -plane?  To answer this question, we compute the flow rates of the vector field  along the sides of the rectangle (counterclockwise), as in , and then we take the limit as to find the circulation density at a point in the -plane.   The counterclockwise circulation of around the rectangle: along each side we take the component of in the direction of travel. Each side's component is drawn in its own color, and the legend gives the dot product it represents.   A rectangle in a vector field with differently colored arrows tracing a counterclockwise loop along its sides, and a legend pairing each color with its dot product.    field(x,y) = (0.4*x + 0.25, 0.32*y + 0.18)      (x,y)    (x+\\Delta x, y)    (x, y+\\Delta y)    (x+\\Delta x, y+\\Delta y)             \\mathbf{F}\\cdot(-\\mathbf{i})\\mathrel{\\unicode{x3C}} 0     \\mathbf{F}\\cdot\\mathbf{i}\\gt 0     \\mathbf{F}\\cdot\\mathbf{j}\\gt 0     \\mathbf{F}\\cdot(-\\mathbf{j})\\mathrel{\\unicode{x3C}} 0    A    \\Delta x    \\Delta y                 Compute the flow rate along each edge, taking the component of in the direction of travel (counterclockwise) times the length of the edge, with evaluated at the corner shown in the figure. Sum the flows along the two pairs of parallel edges, using the same linear approximations as for the divergence, and divide by the area of the rectangle to get the circulation density.     Blank box in three rows, for the flow along each of the four edges, for the sums over the two pairs of parallel edges, and for the circulation density.    This quantity is denoted by and is known as the -component of curl .    The -component of the curl of the vector field is     To find out the circulation density at a point in the -plane, you can imagine a paddle wheel whose axis goes through the point of interest. Then the -component of curl is positive if the fluid flow causes the paddle wheel to rotate counterclockwise, and it is negative if it turns clockwise. The animation in shows both behaviors.   The counterclockwise circulation of around a small rectangle, divided by its area, converges to the -component of curl. A paddle wheel placed in the fluid spins counterclockwise where the curl is positive.     Computing and Interpreting Curl   The vector fields below represent the velocity field of a fluid. Calculate the curl in each case and explain what it means physically.                 Solution. (Identify and , apply , and say what a paddle wheel placed in the fluid would do. The two fields are drawn in .)     Blank box in two labelled rows, one for the k component of the curl of each field with its physical meaning.       Left: the radial field . Right: the rotational field . Compare with the curls you computed: would a paddle wheel spin in each?    A radial field with arrows pointing away from the origin.    fieldA(x,y) = (2*x, 2*y)               A rotational field circulating counterclockwise, arrows longer farther out.    fieldB(x,y) = (-2*y, 2*x)                   The Two Forms of Green's Theorem  Next we state Green's theorem in 2D Note that we only cover Green's theorem in 2D; however, you should know that this theorem can be generalized to 3D, and in that case it is known as Stokes' theorem, which is . , in two forms. The first form relates the outward flux across a simple A curve in the -plane is simple if it does not cross itself. closed curve and the double integral of the divergence over the region bounded by the curve .   Green's Theorem (Flux-Divergence or Normal Form)   Let be a piecewise smooth, simple closed curve enclosing a region in the plane. Let be a vector field with and having continuous first partial derivatives in an open region containing . Then the outward flux of across equals the double integral of over the region enclosed by :     The second form of Green's theorem connects the counterclockwise circulation of a vector field around a simple closed curve and the double integral of the -component of the curl of the field over the region enclosed by the curve.   Green's Theorem (Circulation-Curl or Tangential Form)   Let be a piecewise smooth, simple closed curve enclosing a region in the plane. Let be a vector field with and having continuous first partial derivatives in an open region containing . Then the counterclockwise circulation of around equals the double integral of over :     (Both sides of split into a piece carrying and a piece carrying , so it is enough to prove the two statements and add them. Step 1 : for a region of the kind in , shown in , say why the vertical sides contribute nothing to , write the bottom and top contributions as integrals in (mind the direction of travel along the top), and compare with the double integral done in the -direction first, where the Fundamental Theorem of Calculus evaluates the inner integral. Step 2 : read the other way, as in , and repeat for ; say why no minus sign appears this time. Step 3 : say what to do with a region that cannot be described both ways, and why the cuts cancel; shows the idea. Finally, explain how follows by applying the tangential form to the field .)     Blank box in four rows, for the M statement on a region cut by vertical lines, for the N statement, for the extension to general regions, and for deriving the normal form from the tangential form.       Step 1 of the proof of : a region cut by vertical lines, with for . Counterclockwise, the bottom curve is travelled left to right and the top curve right to left; on the two vertical sides , so they contribute nothing to .   A region between an upper and a lower curve with a counterclockwise boundary.    bottom(t) = (t, 0.55 + 0.30*sin(1.5*t - 0.6))  top(t) = (t, 2.35 - 0.35*sin(1.2*t + 0.4))             a  b  y = f_2(x)  y = f_1(x)   R    dy                  The idea of the proof, without the algebra: the -component of the curl is circulation per unit area, so chop into little cells and add the circulation around each one. Every interior edge is travelled twice, once in each direction, so the inside cancels in pairs and only the circulation around is left.     Verifying Both Forms on the Unit Circle   Assume that the vector field and the closed curve is the unit circle centered at the origin. Convince yourself of the two forms of Green's theorem by applying them to this example.   Solution. (Parametrize the circle, write , , and in terms of , and compute the four partial derivatives. For the normal form , evaluate the line integral and the double integral of the divergence separately and compare; for the tangential form , do the same with and the curl. Both double integrals reduce to the area of the disk. The field is shown in ; compare with .)     Blank box in four rows, for the parametrization with M, N, dx and dy, for the four partial derivatives, for the two sides of the normal form, and for the two sides of the tangential form.       Both forms of Green's theorem for on the unit circle, computed side by side. Use it to check your values of the outward flux and the counterclockwise circulation.     The vector field and the unit circle . The field has a positive (counterclockwise) circulation around .   A swirling field with the unit circle and two tangent vectors.    field(x,y) = (x - y, x)  circ(t) = (cos(t), sin(t))         \\mathbf{T}    \\mathbf{T}    C                A Line Integral via Green's Theorem and Substitution   Evaluate the line integral   where is the boundary of the square with vertices , , , and , shown in . Make suitable substitutions in your integral to make the limits of integration numbers as opposed to functions.   Solution. (Identify and and compute . Use the tangential form to turn the line integral into a double integral over the square . Write the equations of the four sides of the square; they suggest the substitution , that turns into a rectangle with constant limits, as in . Solve for and , compute the Jacobian, and evaluate. Compare with .)     Blank box in five rows, for M, N and the curl, for the double integral given by Green's theorem, for the substitution suggested by the sides, for the inverse and the Jacobian, and for the evaluation.       Green's theorem turns the line integral around the tilted square into a double integral, and a substitution straightens the square into a rectangle with constant limits. Compare with your substitution.     The square with vertices , , , (left) and the corresponding rectangle in the -plane (right).    A square rotated 45 degrees, shaded, with its four edge lines.        y=x+1    y=-x+3    y=-x+1    y=x-1    R    C             The rectangle in the u v plane that is the image of the tilted square.        R'                 An Alternative Form of the Component Test for Conservative Fields  Recall the component test for conservative fields:   Reminder: Component Test for Conservative Fields  Let be a field on a connected and simply connected domain whose component functions have continuous first partial derivatives. Then is conservative if and only if    The three equalities of are equivalent to , since   So to check whether a vector field is conservative or not, we can check whether its curl is zero or not.   Conservative Fields and Green's Theorem   Consider the line integral .     As you know, the vector form of a line integral is . Write down the vector field for the above line integral.    Is this vector field a conservative field? Use the component test, , to answer.    Using Green's theorem, confirm your answer to part B.      Solution. (In A , read and off the differential form. In B , treat as a field in space with and compute the curl by . In C , apply the tangential form to any simple closed curve, and say what the result confirms. Compare with .)     Blank box in three labelled rows, for the vector field, for its curl and the conclusion of the component test, and for the circulation by Green's theorem.       The conservative field has zero curl, so by Green's theorem its circulation around every closed curve is zero.     "
},
{
...
},
{
  "id": "sec-divergence-6",
  "level": "2",
  "url": "section-greens-theorem.html#sec-divergence-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "flux density "
...
},
{
  ...
  "body": " Computing and Interpreting Divergence   The vector fields below represent the velocity field of a gas. Calculate the divergence in each case and explain what it means physically.                 Solution. (Apply to each field, and say what the sign of the result means for the gas at every point. The two fields are drawn in ; does the picture agree?)     Blank box in two labelled rows, one for the divergence of each field with its physical meaning.     "
},
{
  "id": "fig-div-fields",
  "level": "2",
  ...
  "number": "3.1.5",
  "title": "",
  "body": " Left: the field , which flows away from the origin. Right: the field , which circulates around the origin. Compare with the divergences you computed.    A radial field with arrows pointing away from the origin.    fieldA(x,y) = (2*x, 2*y)               A rotational field circulating counterclockwise around the origin.    fieldB(x,y) = (-y\/(x^2 + y^2 + 0.2), x\/(x^2 + y^2 + 0.2))               "
},
{
  "id": "sec-curl-2",
  "level": "2",
...
},
{
  "id": "sec-curl-7",
  "level": "2",
  "url": "section-greens-theorem.html#sec-curl-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "sec-curl-9",
  "level": "2",
  "url": "section-greens-theorem.html#sec-curl-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "paddle wheel "
...
},
{
  ...
  "body": " Computing and Interpreting Curl   The vector fields below represent the velocity field of a fluid. Calculate the curl in each case and explain what it means physically.                 Solution. (Identify and , apply , and say what a paddle wheel placed in the fluid would do. The two fields are drawn in .)     Blank box in two labelled rows, one for the k component of the curl of each field with its physical meaning.     "
},
{
  "id": "fig-curl-fields",
  "level": "2",
  ...
  "number": "3.1.10",
  "title": "",
  "body": " Left: the radial field . Right: the rotational field . Compare with the curls you computed: would a paddle wheel spin in each?    A radial field with arrows pointing away from the origin.    fieldA(x,y) = (2*x, 2*y)               A rotational field circulating counterclockwise, arrows longer farther out.    fieldB(x,y) = (-2*y, 2*x)               "
},
{
...
},
{
  ...
  "body": " Verifying Both Forms on the Unit Circle   Assume that the vector field and the closed curve is the unit circle centered at the origin. Convince yourself of the two forms of Green's theorem by applying them to this example.   Solution. (Parametrize the circle, write , , and in terms of , and compute the four partial derivatives. For the normal form , evaluate the line integral and the double integral of the divergence separately and compare; for the tangential form , do the same with and the curl. Both double integrals reduce to the area of the disk. The field is shown in ; compare with .)     Blank box in four rows, for the parametrization with M, N, dx and dy, for the four partial derivatives, for the two sides of the normal form, and for the two sides of the tangential form.     "
},
{
  ...
  "number": "3.1.16",
  "title": "",
  "body": " Both forms of Green's theorem for on the unit circle, computed side by side. Use it to check your values of the outward flux and the counterclockwise circulation.   "
},
{
  "id": "fig-green-circle",
  "level": "2",
...
},
{
  ...
  "body": " A Line Integral via Green's Theorem and Substitution   Evaluate the line integral   where is the boundary of the square with vertices , , , and , shown in . Make suitable substitutions in your integral to make the limits of integration numbers as opposed to functions.   Solution. (Identify and and compute . Use the tangential form to turn the line integral into a double integral over the square . Write the equations of the four sides of the square; they suggest the substitution , that turns into a rectangle with constant limits, as in . Solve for and , compute the Jacobian, and evaluate. Compare with .)     Blank box in five rows, for M, N and the curl, for the double integral given by Green's theorem, for the substitution suggested by the sides, for the inverse and the Jacobian, and for the evaluation.     "
},
{
  ...
  "number": "3.1.19",
  "title": "",
  "body": " Green's theorem turns the line integral around the tilted square into a double integral, and a substitution straightens the square into a rectangle with constant limits. Compare with your substitution.   "
},
{
  ...
  "number": "3.1.20",
  "title": "",
  "body": " The square with vertices , , , (left) and the corresponding rectangle in the -plane (right).    A square rotated 45 degrees, shaded, with its four edge lines.        y=x+1    y=-x+3    y=-x+1    y=x-1    R    C             The rectangle in the u v plane that is the image of the tilted square.        R'             "
},
{
...
},
{
  ...
  "body": " Computing a Curl   Find for .   Solution. (Identify , , and take the three components of in turn. Then evaluate your curl at and compare with .)     Blank box in two rows, one for the three components of the curl and one for the curl and its value at the point P.     "
},
{
  ...
  "number": "3.2.3",
  "title": "",
  "body": " The curl of at the point . The curl is the axis of the paddle wheel: put the wheel in the plane perpendicular to it and the field turns the wheel the way the arrow shows. Compare the arrow with the vector you computed.   A vector at a point in space with a small paddle wheel turning about it.   At the point P equals one, one, one, a green arrow points in the direction of the curl, up and back toward the negative x direction. A small vermillion circle with four blades sits in the plane perpendicular to that arrow, with an arrowhead showing which way it turns.     "
},
{
...
},
{
  ...
  "body": " Both Sides of Stokes' Theorem   Verify for the field and the upper hemisphere of , oriented by its upward unit normal.   Solution. (The boundary of is the unit circle in the -plane; use the right-hand rule to decide its direction, parametrize it, and compute the circulation. For the other side, compute by ; on the hemisphere the outward unit normal is and, by , . Integrate over the upper hemisphere and compare. The surface is shown in .)     Blank box in four rows, for the parametrized boundary and the integrand, for the circulation, for the curl and the normal, and for the flux of the curl.     "
},
{
...
},
{
  ...
  "body": " A Term That Cannot Be Integrated   Evaluate for where is the circle , , traversed counterclockwise when seen from above.   Solution. (The term makes a direct evaluation hopeless, but Stokes' theorem only ever sees the field through its curl: compute it by and watch the monster disappear. Take the cheapest surface with boundary , the flat disk of ; which unit normal does the right-hand rule pair with the counterclockwise orientation? The integrand is then a constant.)     Blank box in three rows, for the curl, for the flat surface with its normal and the integrand, and for the circulation.     "
},
{
...
},
{
  ...
  "body": " A Tilted Circle   Evaluate for where is the intersection of the sphere with the plane , traversed counterclockwise when seen from above.   Solution. (Where is the centre of the sphere relative to the plane, and so what kind of circle is , with what radius? The again rules out a direct attack and again dies under the curl. Take to be the flat disk that bounds in the plane , shown in ; a normal to the plane is the gradient of , and the right-hand rule picks the upward one. The integrand is constant, so the flux is that constant times the area of the disk. As a check, redo it with the graph protocol over the shadow of , which is an ellipse.)     Blank box in four rows, for the description of the curve and the curl, for the unit normal and the integrand, for the circulation, and for the check by the graph protocol.     "
},
{
  ...
  "number": "3.2.15",
  "title": "",
  "body": " The curve of : the plane cuts the sphere in the circle , and the surface is the flat disk that bounds in that plane, tilted at .   A sphere cut by a slanted plane through its centre, with the great circle and the tilted disk it bounds.   A faint grey sphere of radius three is cut through its centre by a slanted plane. The circle of intersection is drawn in vermillion with arrowheads showing counterclockwise travel seen from above, the flat disk inside it is shaded blue, and a green arrow perpendicular to that disk points up and toward the negative x direction.     "
},
{
  ...
  "body": " Around a Triangle, Twice   Evaluate for where goes from to to and back to along straight line segments, as in . Do the computation twice: directly, and by Stokes' theorem.   Solution. ( Directly : parametrize each of the three segments on , compute , integrate, and add. By Stokes' theorem : compute the curl by ; the triangle lies in the plane through the three vertices, which is the graph of some over a shadow triangle in the -plane. Decide which normal the given traversal pairs with, write for the graph, dot with the curl, and integrate over . Compare the two answers; see .)     Blank box in six rows: three for the direct computation along the three segments with the total, and three for the curl with the plane and shadow, the normal and integrand, and the double integral.     "
},
{
...
},
{
  ...
  "body": " The Curve Nobody Can Parametrize   Evaluate for where is the intersection of the ellipsoid with the paraboloid , traversed counterclockwise when seen from above.   Solution. (Parametrizing this loop, or any surface it bounds, would be miserable. Compute the curl by first. What does the component test then say about , and what does Stokes' theorem give for the circulation, whichever surface the loop bounds? Can you name a potential function?)     Blank box in three rows, for the curl, for the conclusion about the field with a potential function, and for the circulation.     "
},
{
...
},
{
  ...
  "body": " Trading a Paraboloid for a Disk   Evaluate for , where is the part of the paraboloid above the -plane, oriented upward.   Solution. (Find the boundary of and the direction the upward orientation gives it. By you may replace the paraboloid by any surface with the same boundary and compatible orientation: the flat disk of is the easy one. Compute the curl, dot with the disk's normal, and integrate. As a check, parametrize the boundary circle and compute the circulation directly.)     Blank box in three rows, for the boundary and the replacement surface, for the curl and the flux through the disk, and for the direct check of the circulation.     "
},
{
...
},
{
  ...
  "body": " Extension Questions      Does the conclusion remain valid if the common domain is an arbitrary open subset of ?    Which hypothesis of Stokes' theorem is essential in the proof?    How is the result related to conservative vector fields and the Fundamental Theorem for line integrals of ?        Blank box in three labelled rows, one for each extension question.     "
},
{
  ...
  "body": " The Divergence Theorem   In we saw that the divergence of a two-dimensional field measures its flux density, and Green's theorem (in its normal form) converted a flux integral around a closed curve into a double integral of the divergence. In this section we extend both ideas to three dimensions: the result is Gauss's divergence theorem , which converts a flux integral over a closed surface often a lengthy parametrized computation, as in into an ordinary triple integral.     Divergence in 3D  Recall from that in 2D the divergence of is , the flux density of the field at a point: positive where the gas expands, negative where it is compressed (see ). The three-dimensional definition adds one term.    Consider the vector field . Then the divergence of is defined as     If the vector field represents the velocity field of a flowing gas, then the divergence of corresponds to the amount of compression or expansion of the gas at the point .   Expanding or Compressing?   Consider the following velocity fields of a gas, and in each case determine whether the gas is expanding or compressing.                           Solution. (Compute the divergence of each field with and read off the sign. Two of the fields are drawn in . In D , write and use the quotient rule; the three terms combine. What does the answer say about a field whose arrows all point outward? Compare with .)     Blank box in four labelled rows, one for the divergence of each field with its interpretation.       Four velocity fields: expanding, compressing, rotating, and the inverse-square field. Compare with the divergences you computed.     Left: the field , which points radially outward. Right: the field , which rotates about the -axis.   Two 3D vector field plots: one with arrows radiating from the origin, one with arrows circulating around the vertical axis.   Two three-dimensional coordinate boxes. In the left box, blue arrows point away from the origin in every direction, growing longer with distance: the field . In the right box, blue arrows lie in horizontal planes and circulate counterclockwise around the -axis: the field .         Gauss's Divergence Theorem  The divergence theorem relates the outward flux through the surface boundary of a 3D region to the triple integral over the volume of the enclosed region.   Gauss's Divergence Theorem   Let be a vector field whose components have continuous first partial derivatives, and let be a piecewise smooth oriented closed surface. The flux of across in the direction of the surface's outward unit normal field equals the integral of over the region enclosed by the surface:     (Write . Both sides of break into three pieces along the three components, so it is enough to prove and add them; prove the third, the other two being the same argument with the axes renamed. Step 1 : suppose is simple in the -direction, as in , with floor , cap and shadow , so that its boundary is the cap , the floor and the vertical wall of . Say why the wall contributes nothing. On the cap, use for a graph to find ; on the floor the outward normal points the other way. Write the flux as two double integrals over . Step 2 : evaluate the triple integral of by integrating in first, as in , with the Fundamental Theorem of Calculus on the inner integral, and compare. Step 3 : say what to do with a solid that is not simple in all three directions, and why the cut surfaces cancel; shows the idea.)     Blank box in four rows, for the contributions of the wall, cap and floor, for the flux of P k written as double integrals over the shadow, for the triple integral done in the z direction first, and for the extension to general solids.       The solid of Step 1 of the proof of : a solid that is simple in the -direction. Its boundary is the cap where , the floor where , and the vertical wall over the boundary of the shadow . On the wall is tangent, so .   A solid between two curved surfaces over a region in the horizontal plane, with outward normals drawn on the top, the bottom and the side.   A solid sits above a shaded region R in the horizontal plane. Its floor is a gently curved surface and its cap is a higher curved surface; a vertical wall joins them around the edge. A green arrow points upward and outward from the cap, another points downward and outward from the floor, and a third points horizontally outward from the wall, perpendicular to the vertical direction.       The idea of the proof, without the algebra: divergence is flux per unit volume, so chop into little boxes and add the flux out of each one. Every interior face is shared by two boxes and carries opposite outward normals, so the inside cancels in pairs and only the flux through is left.     Flux Through a Sphere, the Easy Way   Use the divergence theorem to compute the flux of the vector field through the sphere .   Solution. (Compute , and then the right-hand side of is a constant times a volume you know. The field is shown in .)     Blank box in two rows, one for the divergence and one for the flux as a triple integral.       The radial field crossing the unit sphere. Compare with the outward flux you found.   A sphere with arrows radiating outward through its surface.   A translucent gray unit sphere centered at the origin. Vermillion arrows pierce the surface from inside, pointing radially outward in every direction and growing with distance from the origin.       Revisiting the Flux of   In we found the flux of across the unit sphere by parametrizing the surface, computing , and integrating a full page of work that produced . Recompute this flux using the divergence theorem.   Solution. (Compute the divergence; then with the unit ball reduces the flux to a volume. Compare with the long computation, and with .)     Blank box in two rows, one for the divergence and one for the flux as a triple integral.       The divergence theorem converts the flux integrals of and through the unit sphere into triple integrals. Use it to check both of your answers.     Revisiting the Paraboloid, the Easy Way   Evaluate the surface integral , where and the surface is the boundary of the solid region enclosed by the paraboloid and the plane , this time using the divergence theorem.   Solution. (In this flux took two surface integrals. Compute the divergence, then apply with the solid described in cylindrical coordinates. Compare with the two-piece computation, and with .)     Blank box in three rows, for the divergence, for the cylindrical description of the solid, and for the flux as a triple integral.       The flux of through the closed paraboloid-and-disk surface: the divergence theorem replaces two surface integrals with one triple integral. Compare its value with yours.     "
},
{
...
},
{
  ...
  "body": " Expanding or Compressing?   Consider the following velocity fields of a gas, and in each case determine whether the gas is expanding or compressing.                           Solution. (Compute the divergence of each field with and read off the sign. Two of the fields are drawn in . In D , write and use the quotient rule; the three terms combine. What does the answer say about a field whose arrows all point outward? Compare with .)     Blank box in four labelled rows, one for the divergence of each field with its interpretation.     "
},
{
  "id": "fig-div3d-video",
  "level": "2",
  ...
  "number": "3.3.3",
  "title": "",
  "body": " Four velocity fields: expanding, compressing, rotating, and the inverse-square field. Compare with the divergences you computed.   "
},
{
  "id": "fig-div3d-fields",
  "level": "2",
  ...
  "number": "3.3.4",
  "title": "",
  "body": " Left: the field , which points radially outward. Right: the field , which rotates about the -axis.   Two 3D vector field plots: one with arrows radiating from the origin, one with arrows circulating around the vertical axis.   Two three-dimensional coordinate boxes. In the left box, blue arrows point away from the origin in every direction, growing longer with distance: the field . In the right box, blue arrows lie in horizontal planes and circulate counterclockwise around the -axis: the field .     "
},
{
  "id": "thm-divergence",
  "level": "2",
...
},
{
  ...
  "body": " Flux Through a Sphere, the Easy Way   Use the divergence theorem to compute the flux of the vector field through the sphere .   Solution. (Compute , and then the right-hand side of is a constant times a volume you know. The field is shown in .)     Blank box in two rows, one for the divergence and one for the flux as a triple integral.     "
},
{
  ...
  "number": "3.3.9",
  "title": "",
  "body": " The radial field crossing the unit sphere. Compare with the outward flux you found.   A sphere with arrows radiating outward through its surface.   A translucent gray unit sphere centered at the origin. Vermillion arrows pierce the surface from inside, pointing radially outward in every direction and growing with distance from the origin.     "
},
{
  ...
  "body": " Revisiting the Flux of   In we found the flux of across the unit sphere by parametrizing the surface, computing , and integrating a full page of work that produced . Recompute this flux using the divergence theorem.   Solution. (Compute the divergence; then with the unit ball reduces the flux to a volume. Compare with the long computation, and with .)     Blank box in two rows, one for the divergence and one for the flux as a triple integral.     "
},
{
  ...
  "number": "3.3.11",
  "title": "",
  "body": " The divergence theorem converts the flux integrals of and through the unit sphere into triple integrals. Use it to check both of your answers.   "
},
{
  ...
  "body": " Revisiting the Paraboloid, the Easy Way   Evaluate the surface integral , where and the surface is the boundary of the solid region enclosed by the paraboloid and the plane , this time using the divergence theorem.   Solution. (In this flux took two surface integrals. Compute the divergence, then apply with the solid described in cylindrical coordinates. Compare with the two-piece computation, and with .)     Blank box in three rows, for the divergence, for the cylindrical description of the solid, and for the flux as a triple integral.     "
},
{
  ...
  "number": "3.3.13",
  "title": "",
  "body": " The flux of through the closed paraboloid-and-disk surface: the divergence theorem replaces two surface integrals with one triple integral. Compare its value with yours.   "
},
{
...
},
{
  ...
  "body": " Mass of a Cone Along the -Axis   An object is bounded by and , and its density is .  The mass of the object is .       Correct.      Incorrect.      "
},
{
  "id": "ex-hw6o-convert",
  "level": "2",
...
},
{
  ...
  "body": " Flux Through a Disk in the -Plane             -pi*a*b^2     Compute the flux of   through the disk of radius centred at the origin in the -plane, oriented in the negative -direction.  Every point of has , so on the field is a constant vector; its -component is .  The flux is .       Correct.   Incorrect.      Correct.   Incorrect.      "
},
{
...
},
{
  ...
  "body": " Flux Across the Surface             (2*u-1)*t    4*k    -4*k    k*(1-exp(1))     Compute the flux , where   and is the surface over , , with pointing upward.  With and , the integrand collapses to a single term . The constant is .  The flux is .       Correct.   Incorrect.      Correct.   Incorrect.      "
},
{
